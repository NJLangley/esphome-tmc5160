...
# These are the required C++ libraries for the TMC5160 stepper driver.
# The SPI library is required for communication with the TMC5160 driver.
# The tommag/TMC5160 library provides the specific implementation for the TMC5160
DEPENDENCIES = ["spi"]
...
TMC5160 = tmc5160_ns.class_("TMC5160_Stepper", stepper.Stepper, cg.Component, spi.SPIDevice)

CONFIG_SCHEMA = (stepper.STEPPER_SCHEMA
                 .extend({
...
async def to_code(config):
    ...
    cg.add_library(name='tommag/TMC5160', version='1.1.0')