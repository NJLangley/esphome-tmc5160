...
template_::TemplateSensor *kitchen_window_blind_max_speed;
template_::TemplateSensor *kitchen_window_blind_acceleration;
template_::TemplateSensor *kitchen_window_blind_deceleration;
template_::TemplateSensor *kitchen_window_blind_current_position;
template_::TemplateSensor *kitchen_window_blind_closed_position;
template_::TemplateSensor *kitchen_window_blind_opening_counter;
template_::TemplateSensor *kitchen_window_blind_closing_counter;
template_::TemplateSensor *kitchen_window_blind_opening_clutch_backlash_adjustment;
...
void setup() {
  ...
  //   build_path: build/kitchen-window-blind
  //   friendly_name: ''
  //   area: ''
  //   platformio_options: {}
  //   includes: []
  //   name_add_mac_suffix: false
  App.pre_setup("kitchen-window-blind", "", "", "", __DATE__ ", " __TIME__, false);
  // stepper:
  // sensor:
  // cover:
  // logger:
  ...
  // wifi:
  //   manual_ip:
  //     static_ip: !secret 'wifi_static_ip_kitchen_window_blind'
  //     gateway: !secret 'wifi_gateway'
  //     subnet: 255.255.255.0
  //     dns1: 0.0.0.0
  //     dns2: 0.0.0.0
  //   ap:
  //     ssid: '{kitchen_window_blind}'
  //     password: password
  //     id: wifi_wifiap_id
  //     ap_timeout: 1min
  ...
  //     id: wifi_wifiap_id_2
  //     priority: 0.0
  //   use_address: 192.168.66.20
  wifi_wificomponent_id = new wifi::WiFiComponent();
  wifi_wificomponent_id->set_use_address("192.168.66.20");
  {
  ...
  wifi_wifiap_id_2.set_manual_ip(wifi::ManualIP{
      .static_ip = network::IPAddress("192.168.66.20"),
  ...
  wifi_wifiap_id.set_ssid("{kitchen_window_blind}");
  ...
  //         id(kitchen_window_blind_opening_clutch_backlash_adjustment).publish_state(id(opening_clutch_backlash_adjustment));
  ...
  //             id(kitchen_window_blind_opening_counter).publish_state(id(opening_counter));
  //   
  //             id(closing_counter) = 0;
  //             id(kitchen_window_blind_closing_counter).publish_state(id(closing_counter));
  ...
  //   opening_clutch_backlash_adjustment: '18'
  // preferences:
  ...
  //     - sensor.template.publish:
  //         id: kitchen_window_blind_max_speed
  //         state: !lambda |-
  //           return speed;
  ...
  //     - sensor.template.publish:
  //         id: kitchen_window_blind_acceleration
  //         state: !lambda |-
  //           return acceleration;
  ...
  //     - sensor.template.publish:
  //         id: kitchen_window_blind_deceleration
  //         state: !lambda |-
  //           return deceleration;
  ...
  //     - sensor.template.publish:
  //         id: kitchen_window_blind_current_position
  //         state: !lambda |-
  //           return id(tmc_stepper).current_position;
  ...
  //   platform: template
  //   id: kitchen_window_blind_max_speed
  //   name: Kitchen Window Blind Max Speed
  //   lambda: !lambda |-
  ...
  //   force_update: false
  //   accuracy_decimals: 1
  kitchen_window_blind_max_speed = new template_::TemplateSensor();
  App.register_sensor(kitchen_window_blind_max_speed);
  kitchen_window_blind_max_speed->set_name("Kitchen Window Blind Max Speed");
  kitchen_window_blind_max_speed->set_object_id("kitchen_window_blind_max_speed");
  kitchen_window_blind_max_speed->set_disabled_by_default(false);
  kitchen_window_blind_max_speed->set_accuracy_decimals(1);
  kitchen_window_blind_max_speed->set_force_update(false);
  kitchen_window_blind_max_speed->set_update_interval(4294967295UL);
  kitchen_window_blind_max_speed->set_component_source("template.sensor");
  App.register_component(kitchen_window_blind_max_speed);
  kitchen_window_blind_max_speed->set_template([=]() -> optional<float> {
  ...
  //   platform: template
  //   id: kitchen_window_blind_acceleration
  //   name: Kitchen Window Blind Acceleration
  //   lambda: !lambda |-
  ...
  //   force_update: false
  //   accuracy_decimals: 1
  kitchen_window_blind_acceleration = new template_::TemplateSensor();
  App.register_sensor(kitchen_window_blind_acceleration);
  kitchen_window_blind_acceleration->set_name("Kitchen Window Blind Acceleration");
  kitchen_window_blind_acceleration->set_object_id("kitchen_window_blind_acceleration");
  kitchen_window_blind_acceleration->set_disabled_by_default(false);
  kitchen_window_blind_acceleration->set_accuracy_decimals(1);
  kitchen_window_blind_acceleration->set_force_update(false);
  kitchen_window_blind_acceleration->set_update_interval(4294967295UL);
  kitchen_window_blind_acceleration->set_component_source("template.sensor");
  App.register_component(kitchen_window_blind_acceleration);
  kitchen_window_blind_acceleration->set_template([=]() -> optional<float> {
  ...
  //   platform: template
  //   id: kitchen_window_blind_deceleration
  //   name: Kitchen Window Blind Deceleration
  //   lambda: !lambda |-
  ...
  //   force_update: false
  //   accuracy_decimals: 1
  kitchen_window_blind_deceleration = new template_::TemplateSensor();
  App.register_sensor(kitchen_window_blind_deceleration);
  kitchen_window_blind_deceleration->set_name("Kitchen Window Blind Deceleration");
  kitchen_window_blind_deceleration->set_object_id("kitchen_window_blind_deceleration");
  kitchen_window_blind_deceleration->set_disabled_by_default(false);
  kitchen_window_blind_deceleration->set_accuracy_decimals(1);
  kitchen_window_blind_deceleration->set_force_update(false);
  kitchen_window_blind_deceleration->set_update_interval(4294967295UL);
  kitchen_window_blind_deceleration->set_component_source("template.sensor");
  App.register_component(kitchen_window_blind_deceleration);
  kitchen_window_blind_deceleration->set_template([=]() -> optional<float> {
  ...
  //   platform: template
  //   id: kitchen_window_blind_current_position
  //   name: Kitchen Window Blind Current position
  //   lambda: !lambda |-
  //     return id(tmc_stepper).current_position;
  //   update_interval: 4294967295
  //   disabled_by_default: false
  //   force_update: false
  //   accuracy_decimals: 1
  kitchen_window_blind_current_position = new template_::TemplateSensor();
  App.register_sensor(kitchen_window_blind_current_position);
  kitchen_window_blind_current_position->set_name("Kitchen Window Blind Current position");
  kitchen_window_blind_current_position->set_object_id("kitchen_window_blind_current_position");
  kitchen_window_blind_current_position->set_disabled_by_default(false);
  kitchen_window_blind_current_position->set_accuracy_decimals(1);
  kitchen_window_blind_current_position->set_force_update(false);
  kitchen_window_blind_current_position->set_update_interval(4294967295UL);
  kitchen_window_blind_current_position->set_component_source("template.sensor");
  App.register_component(kitchen_window_blind_current_position);
  kitchen_window_blind_current_position->set_template([=]() -> optional<float> {
  ...
  //   platform: template
  //   id: kitchen_window_blind_closed_position
  //   name: Kitchen Window Blind Closed position
  //   lambda: !lambda |-
  //     return id(closed_position);
  //   update_interval: 4294967295
  //   disabled_by_default: false
  //   force_update: false
  //   accuracy_decimals: 1
  kitchen_window_blind_closed_position = new template_::TemplateSensor();
  App.register_sensor(kitchen_window_blind_closed_position);
  kitchen_window_blind_closed_position->set_name("Kitchen Window Blind Closed position");
  kitchen_window_blind_closed_position->set_object_id("kitchen_window_blind_closed_position");
  kitchen_window_blind_closed_position->set_disabled_by_default(false);
  kitchen_window_blind_closed_position->set_accuracy_decimals(1);
  kitchen_window_blind_closed_position->set_force_update(false);
  kitchen_window_blind_closed_position->set_update_interval(4294967295UL);
  kitchen_window_blind_closed_position->set_component_source("template.sensor");
  App.register_component(kitchen_window_blind_closed_position);
  // sensor.template:
  //   platform: template
  //   id: kitchen_window_blind_opening_counter
  //   name: Kitchen Window Blind Opening Counter
  //   lambda: !lambda |-
  //     return id(opening_counter);
  //   update_interval: 4294967295
  //   disabled_by_default: false
  //   force_update: false
  //   accuracy_decimals: 1
  kitchen_window_blind_opening_counter = new template_::TemplateSensor();
  App.register_sensor(kitchen_window_blind_opening_counter);
  kitchen_window_blind_opening_counter->set_name("Kitchen Window Blind Opening Counter");
  kitchen_window_blind_opening_counter->set_object_id("kitchen_window_blind_opening_counter");
  kitchen_window_blind_opening_counter->set_disabled_by_default(false);
  kitchen_window_blind_opening_counter->set_accuracy_decimals(1);
  kitchen_window_blind_opening_counter->set_force_update(false);
  kitchen_window_blind_opening_counter->set_update_interval(4294967295UL);
  kitchen_window_blind_opening_counter->set_component_source("template.sensor");
  App.register_component(kitchen_window_blind_opening_counter);
  // sensor.template:
  //   platform: template
  //   id: kitchen_window_blind_closing_counter
  //   name: Kitchen Window Blind Closing Counter
  //   lambda: !lambda |-
  //     return id(closing_counter);
  //   update_interval: 4294967295
  //   disabled_by_default: false
  //   force_update: false
  //   accuracy_decimals: 1
  kitchen_window_blind_closing_counter = new template_::TemplateSensor();
  App.register_sensor(kitchen_window_blind_closing_counter);
  kitchen_window_blind_closing_counter->set_name("Kitchen Window Blind Closing Counter");
  kitchen_window_blind_closing_counter->set_object_id("kitchen_window_blind_closing_counter");
  kitchen_window_blind_closing_counter->set_disabled_by_default(false);
  kitchen_window_blind_closing_counter->set_accuracy_decimals(1);
  kitchen_window_blind_closing_counter->set_force_update(false);
  kitchen_window_blind_closing_counter->set_update_interval(4294967295UL);
  kitchen_window_blind_closing_counter->set_component_source("template.sensor");
  App.register_component(kitchen_window_blind_closing_counter);
  // sensor.template:
  //   platform: template
  //   id: kitchen_window_blind_opening_clutch_backlash_adjustment
  //   name: Kitchen Window Blind Opening Clutch Backlash Adjustment
  //   lambda: !lambda |-
  //     return id(opening_clutch_backlash_adjustment);
  //   update_interval: 4294967295
  //   disabled_by_default: false
  //   force_update: false
  //   accuracy_decimals: 1
  kitchen_window_blind_opening_clutch_backlash_adjustment = new template_::TemplateSensor();
  App.register_sensor(kitchen_window_blind_opening_clutch_backlash_adjustment);
  kitchen_window_blind_opening_clutch_backlash_adjustment->set_name("Kitchen Window Blind Opening Clutch Backlash Adjustment");
  kitchen_window_blind_opening_clutch_backlash_adjustment->set_object_id("kitchen_window_blind_opening_clutch_backlash_adjustment");
  kitchen_window_blind_opening_clutch_backlash_adjustment->set_disabled_by_default(false);
  kitchen_window_blind_opening_clutch_backlash_adjustment->set_accuracy_decimals(1);
  kitchen_window_blind_opening_clutch_backlash_adjustment->set_force_update(false);
  kitchen_window_blind_opening_clutch_backlash_adjustment->set_update_interval(4294967295UL);
  kitchen_window_blind_opening_clutch_backlash_adjustment->set_component_source("template.sensor");
  App.register_component(kitchen_window_blind_opening_clutch_backlash_adjustment);
  // sensor.uptime:
  //   platform: uptime
  //   name: Uptime Sensor
  //   disabled_by_default: false
  ...
  blind_cover->set_name("Kitchen Window Blind");
  blind_cover->set_object_id("kitchen_window_blind");
  ...
  //   initial_value: '18'
  //   restore_value: true
  opening_clutch_backlash_adjustment = new globals::RestoringGlobalsComponent<int>(18);
  ...
  sensor_sensorpublishaction_id_5 = new sensor::SensorPublishAction<int>(kitchen_window_blind_max_speed);
  ...
  sensor_sensorpublishaction_id_6 = new sensor::SensorPublishAction<int>(kitchen_window_blind_acceleration);
  ...
  sensor_sensorpublishaction_id_7 = new sensor::SensorPublishAction<int>(kitchen_window_blind_deceleration);
  ...
  sensor_sensorpublishaction_id_8 = new sensor::SensorPublishAction<>(kitchen_window_blind_current_position);
  ...
  lambdaaction_id_5 = new LambdaAction<>([=]() -> void {
      ...
      if (tmc_stepper->has_reached_target() && blind_cover->current_operation != COVER_OPERATION_IDLE) {
        ...
        kitchen_window_blind_closing_counter->publish_state(closing_counter->value());
      }
        ...
        kitchen_window_blind_opening_counter->publish_state(opening_counter->value());
      }
  });
  ...
  lambdaaction_id_6 = new LambdaAction<int32_t>([=](int32_t clutch_backlash_adjustment) -> void {
      ...
      kitchen_window_blind_opening_clutch_backlash_adjustment->publish_state(opening_clutch_backlash_adjustment->value());
  });
  ...
  kitchen_window_blind_closed_position->set_template([=]() -> optional<float> {
      #line 265 "packages/roller_blind.yaml"
      return closed_position->value();
  });
  kitchen_window_blind_opening_counter->set_template([=]() -> optional<float> {
      #line 271 "packages/roller_blind.yaml"
      return opening_counter->value();
  });
  kitchen_window_blind_closing_counter->set_template([=]() -> optional<float> {
      #line 277 "packages/roller_blind.yaml"
      return closing_counter->value();
  });
  kitchen_window_blind_opening_clutch_backlash_adjustment->set_template([=]() -> optional<float> {
  ...
  sensor_sensorpublishaction_id = new sensor::SensorPublishAction<>(kitchen_window_blind_closed_position);
  sensor_sensorpublishaction_id->set_state([=]() -> float {
      #line 14 "packages/roller_blind.yaml"
      return closed_position->value();
  });
  sensor_sensorpublishaction_id_2 = new sensor::SensorPublishAction<>(kitchen_window_blind_closing_counter);
  sensor_sensorpublishaction_id_2->set_state([=]() -> float {
      #line 17 "packages/roller_blind.yaml"
      return closing_counter->value();
  });
  sensor_sensorpublishaction_id_3 = new sensor::SensorPublishAction<>(kitchen_window_blind_opening_counter);
  sensor_sensorpublishaction_id_3->set_state([=]() -> float {
      #line 20 "packages/roller_blind.yaml"
      return opening_counter->value();
  });
  sensor_sensorpublishaction_id_4 = new sensor::SensorPublishAction<>(kitchen_window_blind_opening_clutch_backlash_adjustment);
