...
template_::TemplateSensor *testbed_window_blind_current_position;
template_::TemplateSensor *testbed_window_blind_closed_position;
template_::TemplateSensor *testbed_window_blind_opening_counter;
template_::TemplateSensor *testbed_window_blind_closing_counter;
template_::TemplateSensor *testbed_window_blind_opening_clutch_backlash_adjustment;
...
void setup() {
  ...
  //     priority: 600.0
  //   build_path: build/testbed-window-blind
  //   friendly_name: ''
  //   area: ''
  //   platformio_options: {}
  //   includes: []
  ...
  App.pre_setup("testbed-window-blind", "", "", "", __DATE__ ", " __TIME__, false);
  // stepper:
  // cover:
  // sensor:
  // logger:
  ...
  // wifi:
  //   manual_ip:
  //     static_ip: !secret 'wifi_static_ip_testbed_window_blind'
  //     gateway: !secret 'wifi_gateway'
  //     subnet: 255.255.255.0
  //     dns1: 0.0.0.0
  //     dns2: 0.0.0.0
  //   ap:
  //     ssid: '{testbed_window_blind}'
  //     password: password
  //     id: wifi_wifiap_id
  //     ap_timeout: 1min
  ...
  //     id: wifi_wifiap_id_2
  //     priority: 0.0
  //   use_address: 192.168.66.25
  wifi_wificomponent_id = new wifi::WiFiComponent();
  wifi_wificomponent_id->set_use_address("192.168.66.25");
  {
  ...
  wifi_wifiap_id_2.set_manual_ip(wifi::ManualIP{
      .static_ip = network::IPAddress(192, 168, 66, 25),
  ...
  wifi_wifiap_id.set_ssid("{testbed_window_blind}");
  ...
  //         id(testbed_window_blind_opening_clutch_backlash_adjustment).publish_state(id(opening_counter));
  ...
  //             id(testbed_window_blind_opening_counter).publish_state(id(opening_counter));
  //   
  //             id(closing_counter) = 0;
  //             id(testbed_window_blind_closing_counter).publish_state(id(closing_counter));
  ...
  // substitutions:
  //   device_name: testbed-window-blind
  //   friendly_name: Testbed Window Blind
  //   node_name: testbed_window_blind
  //   wifi_static_ip: !secret 'wifi_static_ip_testbed_window_blind'
  ...
  //     - sensor.template.publish:
  //         id: testbed_window_blind_current_position
  //         state: !lambda |-
  //           return id(tmc_stepper).current_position;
  ...
  blind_cover->set_name("Testbed Window Blind");
  blind_cover->set_object_id("testbed_window_blind");
  ...
  //   platform: template
  //   id: testbed_window_blind_current_position
  //   name: Testbed Window Blind Current position
  //   lambda: !lambda |-
  //     return id(tmc_stepper).current_position;
  ...
  //   force_update: false
  //   accuracy_decimals: 1
  testbed_window_blind_current_position = new template_::TemplateSensor();
  App.register_sensor(testbed_window_blind_current_position);
  testbed_window_blind_current_position->set_name("Testbed Window Blind Current position");
  testbed_window_blind_current_position->set_object_id("testbed_window_blind_current_position");
  testbed_window_blind_current_position->set_disabled_by_default(false);
  testbed_window_blind_current_position->set_accuracy_decimals(1);
  testbed_window_blind_current_position->set_force_update(false);
  testbed_window_blind_current_position->set_update_interval(4294967295UL);
  testbed_window_blind_current_position->set_component_source("template.sensor");
  App.register_component(testbed_window_blind_current_position);
  testbed_window_blind_current_position->set_template([=]() -> optional<float> {
  ...
  //   platform: template
  //   id: testbed_window_blind_closed_position
  //   name: Testbed Window Blind Closed position
  //   lambda: !lambda |-
  //     return id(closed_position);
  //   update_interval: 4294967295
  //   disabled_by_default: false
  //   force_update: false
  //   accuracy_decimals: 1
  testbed_window_blind_closed_position = new template_::TemplateSensor();
  App.register_sensor(testbed_window_blind_closed_position);
  testbed_window_blind_closed_position->set_name("Testbed Window Blind Closed position");
  testbed_window_blind_closed_position->set_object_id("testbed_window_blind_closed_position");
  testbed_window_blind_closed_position->set_disabled_by_default(false);
  testbed_window_blind_closed_position->set_accuracy_decimals(1);
  testbed_window_blind_closed_position->set_force_update(false);
  testbed_window_blind_closed_position->set_update_interval(4294967295UL);
  testbed_window_blind_closed_position->set_component_source("template.sensor");
  App.register_component(testbed_window_blind_closed_position);
  // sensor.template:
  //   platform: template
  //   id: testbed_window_blind_opening_counter
  //   name: Testbed Window Blind Opening Counter
  //   lambda: !lambda |-
  //     return id(opening_counter);
  //   update_interval: 4294967295
  //   disabled_by_default: false
  //   force_update: false
  //   accuracy_decimals: 1
  testbed_window_blind_opening_counter = new template_::TemplateSensor();
  App.register_sensor(testbed_window_blind_opening_counter);
  testbed_window_blind_opening_counter->set_name("Testbed Window Blind Opening Counter");
  testbed_window_blind_opening_counter->set_object_id("testbed_window_blind_opening_counter");
  testbed_window_blind_opening_counter->set_disabled_by_default(false);
  testbed_window_blind_opening_counter->set_accuracy_decimals(1);
  testbed_window_blind_opening_counter->set_force_update(false);
  testbed_window_blind_opening_counter->set_update_interval(4294967295UL);
  testbed_window_blind_opening_counter->set_component_source("template.sensor");
  App.register_component(testbed_window_blind_opening_counter);
  // sensor.template:
  //   platform: template
  //   id: testbed_window_blind_closing_counter
  //   name: Testbed Window Blind Closing Counter
  //   lambda: !lambda |-
  //     return id(closing_counter);
  //   update_interval: 4294967295
  //   disabled_by_default: false
  //   force_update: false
  //   accuracy_decimals: 1
  testbed_window_blind_closing_counter = new template_::TemplateSensor();
  App.register_sensor(testbed_window_blind_closing_counter);
  testbed_window_blind_closing_counter->set_name("Testbed Window Blind Closing Counter");
  testbed_window_blind_closing_counter->set_object_id("testbed_window_blind_closing_counter");
  testbed_window_blind_closing_counter->set_disabled_by_default(false);
  testbed_window_blind_closing_counter->set_accuracy_decimals(1);
  testbed_window_blind_closing_counter->set_force_update(false);
  testbed_window_blind_closing_counter->set_update_interval(4294967295UL);
  testbed_window_blind_closing_counter->set_component_source("template.sensor");
  App.register_component(testbed_window_blind_closing_counter);
  // sensor.template:
  //   platform: template
  //   id: testbed_window_blind_opening_clutch_backlash_adjustment
  //   name: Testbed Window Blind Opening Clutch Backlash Adjustment
  //   lambda: !lambda |-
  //     return id(opening_clutch_backlash_adjustment);
  //   update_interval: 4294967295
  //   disabled_by_default: false
  //   force_update: false
  //   accuracy_decimals: 1
  testbed_window_blind_opening_clutch_backlash_adjustment = new template_::TemplateSensor();
  App.register_sensor(testbed_window_blind_opening_clutch_backlash_adjustment);
  testbed_window_blind_opening_clutch_backlash_adjustment->set_name("Testbed Window Blind Opening Clutch Backlash Adjustment");
  testbed_window_blind_opening_clutch_backlash_adjustment->set_object_id("testbed_window_blind_opening_clutch_backlash_adjustment");
  testbed_window_blind_opening_clutch_backlash_adjustment->set_disabled_by_default(false);
  testbed_window_blind_opening_clutch_backlash_adjustment->set_accuracy_decimals(1);
  testbed_window_blind_opening_clutch_backlash_adjustment->set_force_update(false);
  testbed_window_blind_opening_clutch_backlash_adjustment->set_update_interval(4294967295UL);
  testbed_window_blind_opening_clutch_backlash_adjustment->set_component_source("template.sensor");
  App.register_component(testbed_window_blind_opening_clutch_backlash_adjustment);
  // sensor.uptime:
  //   platform: uptime
  //   name: Uptime Sensor
  //   disabled_by_default: false
  ...
  blind_cover->set_has_position(true);
  testbed_window_blind_closed_position->set_template([=]() -> optional<float> {
      #line 265 "packages/roller_blind.yaml"
      return closed_position->value();
  });
  testbed_window_blind_opening_counter->set_template([=]() -> optional<float> {
      #line 271 "packages/roller_blind.yaml"
      return opening_counter->value();
  });
  testbed_window_blind_closing_counter->set_template([=]() -> optional<float> {
      #line 277 "packages/roller_blind.yaml"
      return closing_counter->value();
  });
  testbed_window_blind_opening_clutch_backlash_adjustment->set_template([=]() -> optional<float> {
  ...
  sensor_sensorpublishaction_id = new sensor::SensorPublishAction<>(testbed_window_blind_closed_position);
  sensor_sensorpublishaction_id->set_state([=]() -> float {
      #line 14 "packages/roller_blind.yaml"
      return closed_position->value();
  });
  sensor_sensorpublishaction_id_2 = new sensor::SensorPublishAction<>(testbed_window_blind_closing_counter);
  sensor_sensorpublishaction_id_2->set_state([=]() -> float {
      #line 17 "packages/roller_blind.yaml"
      return closing_counter->value();
  });
  sensor_sensorpublishaction_id_3 = new sensor::SensorPublishAction<>(testbed_window_blind_opening_counter);
  sensor_sensorpublishaction_id_3->set_state([=]() -> float {
      #line 20 "packages/roller_blind.yaml"
      return opening_counter->value();
  });
  sensor_sensorpublishaction_id_4 = new sensor::SensorPublishAction<>(testbed_window_blind_opening_clutch_backlash_adjustment);
  ...
  lambdaaction_id = new LambdaAction<int32_t>([=](int32_t clutch_backlash_adjustment) -> void {
      ...
      testbed_window_blind_opening_clutch_backlash_adjustment->publish_state(opening_counter->value());
  });
  ...
  lambdaaction_id_2 = new LambdaAction<>([=]() -> void {
      ...
      testbed_window_blind_opening_counter->publish_state(opening_counter->value());
      
      closing_counter->value() = 0;
      testbed_window_blind_closing_counter->publish_state(closing_counter->value());
  });
  ...
  sensor_sensorpublishaction_id_5 = new sensor::SensorPublishAction<>(testbed_window_blind_current_position);
