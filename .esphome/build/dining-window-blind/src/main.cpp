...
script::SingleScript<int> *set_speed;
script::SingleScript<int> *set_acceleration;
script::SingleScript<int> *set_deceleration;
...
script::ScriptExecuteAction<script::Script<int>, int32_t> *script_scriptexecuteaction_id_10;
api::UserServiceTrigger<int32_t> *api_userservicetrigger_id_2;
Automation<int32_t> *automation_id_11;
script::ScriptExecuteAction<script::Script<int>, int32_t> *script_scriptexecuteaction_id_11;
api::UserServiceTrigger<int32_t> *api_userservicetrigger_id_3;
Automation<int32_t> *automation_id_12;
script::ScriptExecuteAction<script::Script<int>, int32_t> *script_scriptexecuteaction_id_12;
api::UserServiceTrigger<int32_t> *api_userservicetrigger_id_4;
Automation<int32_t> *automation_id_13;
stepper::SetTargetAction<int32_t> *stepper_settargetaction_id;
script::ScriptExecuteAction<script::Script<>, int32_t> *script_scriptexecuteaction_id_13;
api::UserServiceTrigger<int32_t> *api_userservicetrigger_id_5;
Automation<int32_t> *automation_id_14;
template_::TemplateSensor *dining_window_blind_max_speed;
template_::TemplateSensor *dining_window_blind_acceleration;
template_::TemplateSensor *dining_window_blind_deceleration;
template_::TemplateSensor *dining_window_blind_current_position;
template_::TemplateSensor *dining_window_blind_closed_position;
template_::TemplateSensor *dining_window_blind_opening_counter;
template_::TemplateSensor *dining_window_blind_closing_counter;
template_::TemplateSensor *dining_window_blind_opening_clutch_backlash_adjustment;
...
Automation<float> *automation_id_18;
...
LambdaAction<int> *lambdaaction_id;
text_sensor::TextSensorPublishAction<float> *text_sensor_textsensorpublishaction_id;
globals::RestoringGlobalsComponent<float> *saved_speed;
globals::RestoringGlobalsComponent<float> *saved_acceleration;
globals::RestoringGlobalsComponent<float> *saved_deceleration;
...
globals::GlobalVarSetAction<globals::RestoringGlobalsComponent<float>, int> *globals_globalvarsetaction_id;
sensor::SensorPublishAction<int> *sensor_sensorpublishaction_id_5;
Automation<int> *automation_id_3;
LambdaAction<int> *lambdaaction_id_2;
globals::GlobalVarSetAction<globals::RestoringGlobalsComponent<float>, int> *globals_globalvarsetaction_id_2;
sensor::SensorPublishAction<int> *sensor_sensorpublishaction_id_6;
Automation<int> *automation_id_4;
LambdaAction<int> *lambdaaction_id_3;
globals::GlobalVarSetAction<globals::RestoringGlobalsComponent<float>, int> *globals_globalvarsetaction_id_3;
sensor::SensorPublishAction<int> *sensor_sensorpublishaction_id_7;
Automation<> *automation_id_5;
globals::GlobalVarSetAction<globals::RestoringGlobalsComponent<int>> *globals_globalvarsetaction_id_4;
Automation<int> *automation_id_6;
LambdaAction<int> *lambdaaction_id_4;
script::ScriptExecuteAction<script::Script<>, int> *script_scriptexecuteaction_id_6;
Automation<> *automation_id_7;
cover::CoverPublishAction<> *cover_coverpublishaction_id;
sensor::SensorPublishAction<> *sensor_sensorpublishaction_id_8;
...
script::ScriptExecuteAction<script::Script<>> *script_scriptexecuteaction_id_7;
...
LambdaAction<int32_t> *lambdaaction_id_6;
api::UserServiceTrigger<int32_t> *api_userservicetrigger_id_6;
Automation<int32_t> *automation_id_15;
LambdaCondition<int32_t> *lambdacondition_id_2;
IfAction<int32_t> *ifaction_id;
api::HomeAssistantServiceCallAction<int32_t> *api_homeassistantservicecallaction_id;
script::ScriptExecuteAction<script::Script<int>, int32_t> *script_scriptexecuteaction_id_14;
script::ScriptExecuteAction<script::Script<>, int32_t> *script_scriptexecuteaction_id_15;
script::ScriptExecuteAction<script::Script<>, int32_t> *script_scriptexecuteaction_id_16;
api::UserServiceTrigger<> *api_userservicetrigger_id_7;
...
api::UserServiceTrigger<std::string> *api_userservicetrigger_id_8;
Automation<std::string> *automation_id_17;
LambdaAction<std::string> *lambdaaction_id_8;
...
script::ScriptExecuteAction<script::Script<>> *script_scriptexecuteaction_id_17;
Automation<> *automation_id_20;
LambdaAction<> *lambdaaction_id_11;
stepper::SetTargetAction<> *stepper_settargetaction_id_3;
script::ScriptExecuteAction<script::Script<>> *script_scriptexecuteaction_id_18;
Automation<> *automation_id_22;
LambdaAction<> *lambdaaction_id_16;
LambdaAction<> *lambdaaction_id_17;
script::ScriptExecuteAction<script::Script<>> *script_scriptexecuteaction_id_20;
Automation<float> *automation_id_21;
LambdaAction<float> *lambdaaction_id_12;
LambdaAction<float> *lambdaaction_id_13;
...
LambdaAction<float> *lambdaaction_id_14;
LambdaAction<float> *lambdaaction_id_15;
stepper::SetTargetAction<float> *stepper_settargetaction_id_4;
script::ScriptExecuteAction<script::Script<>, float> *script_scriptexecuteaction_id_19;
...
void setup() {
  ...
  //             id: set_speed
  //             speed: !lambda |-
  //               return id(saved_speed);
  //           type_id: script_scriptexecuteaction_id
  //         - script.execute:
  //             id: set_acceleration
  //             acceleration: !lambda |-
  //               return id(saved_acceleration);
  //           type_id: script_scriptexecuteaction_id_2
  //         - script.execute:
  //             id: set_deceleration
  //             deceleration: !lambda |-
  //               return id(saved_deceleration);
  ...
  //   build_path: build/dining-window-blind
  //   friendly_name: ''
  //   platformio_options: {}
  //   includes: []
  ...
  //   areas: []
  //   devices: []
  App.pre_setup("dining-window-blind", "", "", __DATE__ ", " __TIME__, false);
  App.reserve_components(38);
  // stepper:
  // sensor:
  // cover:
  // text_sensor:
  ...
  // wifi:
  //   manual_ip:
  //     static_ip: !secret 'wifi_static_ip_dining_window_blind'
  //     gateway: !secret 'wifi_gateway'
  //     subnet: 255.255.255.0
  //     dns1: 0.0.0.0
  //     dns2: 0.0.0.0
  //   ap:
  //     ssid: '{dining_window_blind}'
  //     password: password
  //     id: wifi_wifiap_id
  //     ap_timeout: 1min
  ...
  //       id: wifi_wifiap_id_2
  //       priority: 0.0
  //   use_address: 192.168.66.21
  wifi_wificomponent_id = new wifi::WiFiComponent();
  wifi_wificomponent_id->set_use_address("192.168.66.21");
  {
  ...
  wifi_wifiap_id_2.set_manual_ip(wifi::ManualIP{
      .static_ip = network::IPAddress("192.168.66.21"),
  ...
  wifi_wifiap_id.set_ssid("{dining_window_blind}");
  ...
  automation_id_23 = new Automation<>(ota_otastarttrigger_id);
  lambdaaction_id_18 = new LambdaAction<>([=]() -> void {
      ESP_LOGD("main", "OTA start");
  });
  automation_id_23->add_actions({lambdaaction_id_18});
  ota_otaprogresstrigger_id = new ota::OTAProgressTrigger(esphome_esphomeotacomponent_id);
  automation_id_24 = new Automation<float>(ota_otaprogresstrigger_id);
  lambdaaction_id_19 = new LambdaAction<float>([=](float x) -> void {
      ESP_LOGD("main", "OTA progress %0.1f%%", x);
  });
  automation_id_24->add_actions({lambdaaction_id_19});
  ota_otaendtrigger_id = new ota::OTAEndTrigger(esphome_esphomeotacomponent_id);
  automation_id_25 = new Automation<>(ota_otaendtrigger_id);
  lambdaaction_id_20 = new LambdaAction<>([=]() -> void {
      ESP_LOGD("main", "OTA end");
  });
  automation_id_25->add_actions({lambdaaction_id_20});
  // api:
  //   actions:
  //     - action: set_speed
  //       variables:
  ...
  //             id(dining_window_blind_opening_clutch_backlash_adjustment).publish_state(id(opening_clutch_backlash_adjustment));
  ...
  //                   data:
  //                     message: Service set_stepper_position is not available while the
  //                       blind motor is moving. Please try again once the blind has stopped.
  ...
  //       trigger_id: api_userservicetrigger_id_6
  ...
  //                   action: system_log.write
  //                   data:
  //                     message: Service reset_counters is not available while the blind
  ...
  //                   id(dining_window_blind_opening_counter).publish_state(id(opening_counter));
  //   
  //                   id(closing_counter) = 0;
  //                   id(dining_window_blind_closing_counter).publish_state(id(closing_counter));
  //                 type_id: lambdaaction_id_7
  //           type_id: ifaction_id_2
  //       automation_id: automation_id_16
  //       trigger_id: api_userservicetrigger_id_7
  //       variables: {}
  //     - action: log_message
  //       variables:
  //         message: string
  //       then:
  //         - lambda: !lambda |-
  //             static const char *const TAG = "tmc5160.stepper"; ESP_LOGI(TAG, "action call: log_message: %s", message);
  //           type_id: lambdaaction_id_8
  //         - homeassistant.action:
  //             action: system_log.write
  //             data:
  //               message: !lambda |-
  //                 return "action call: log_message: " + message;
  //               logger: esphome.tmc5160
  //               level: error
  //             id: api_apiserver_id
  //             data_template: {}
  ...
  //       trigger_id: api_userservicetrigger_id_8
  //   id: api_apiserver_id
  //   port: 6053
  //   password: ''
  //   reboot_timeout: 15min
  ...
  api_userservicetrigger_id = new api::UserServiceTrigger<int32_t>("set_speed", {"speed"});
  api_apiserver_id->register_user_service(api_userservicetrigger_id);
  automation_id_10 = new Automation<int32_t>(api_userservicetrigger_id);
  ...
  //     then:
  //       - lambda: !lambda |-
  //           id(tmc_stepper).set_max_speed(speed);
  ...
  //       - sensor.template.publish:
  //           id: dining_window_blind_max_speed
  //           state: !lambda |-
  //             return speed;
  ...
  //     then:
  //       - lambda: !lambda |-
  //           id(tmc_stepper).set_acceleration(acceleration);
  ...
  //       - sensor.template.publish:
  //           id: dining_window_blind_acceleration
  //           state: !lambda |-
  //             return acceleration;
  //         type_id: sensor_sensorpublishaction_id_6
  ...
  //     then:
  //       - lambda: !lambda |-
  //           id(tmc_stepper).set_deceleration(deceleration);
  ...
  //       - sensor.template.publish:
  //           id: dining_window_blind_deceleration
  //           state: !lambda |-
  //             return deceleration;
  //         type_id: sensor_sensorpublishaction_id_7
  ...
  //       - sensor.template.publish:
  //           id: dining_window_blind_current_position
  //           state: !lambda |-
  //             return id(tmc_stepper).current_position;
  //         type_id: sensor_sensorpublishaction_id_8
  ...
  //     mode: single
  //     parameters: {}
  set_speed = new script::SingleScript<int>();
  set_speed->set_name("set_speed");
  set_acceleration = new script::SingleScript<int>();
  set_acceleration->set_name("set_acceleration");
  set_deceleration = new script::SingleScript<int>();
  set_deceleration->set_name("set_deceleration");
  ...
  automation_id_2 = new Automation<int>(set_speed);
  // stepper.tmc5160:
  //   platform: tmc5160
  //   id: tmc_stepper
  //   cs_pin:
  ...
  tmc_stepper->set_acceleration(1500.0f);
  tmc_stepper->set_deceleration(1500.0f);
  tmc_stepper->set_max_speed(1000.0f);
  ...
  tmc_stepper->set_motor_direction_reversed(true);
  script_scriptexecuteaction_id_10 = new script::ScriptExecuteAction<script::Script<int>, int32_t>(set_speed);
  script_scriptexecuteaction_id_10->set_args([=](int32_t speed) -> int {
      #line 129 "packages/tmc5160_stepper_esp8266_d1_mini.yaml"
      return (float)speed;
  });
  automation_id_10->add_actions({script_scriptexecuteaction_id_10});
  api_userservicetrigger_id_2 = new api::UserServiceTrigger<int32_t>("set_acceleration", {"acceleration"});
  api_apiserver_id->register_user_service(api_userservicetrigger_id_2);
  automation_id_11 = new Automation<int32_t>(api_userservicetrigger_id_2);
  script_scriptexecuteaction_id_11 = new script::ScriptExecuteAction<script::Script<int>, int32_t>(set_acceleration);
  script_scriptexecuteaction_id_11->set_args([=](int32_t acceleration) -> int {
      #line 137 "packages/tmc5160_stepper_esp8266_d1_mini.yaml"
      return (float)acceleration;
  });
  automation_id_11->add_actions({script_scriptexecuteaction_id_11});
  api_userservicetrigger_id_3 = new api::UserServiceTrigger<int32_t>("set_deceleration", {"deceleration"});
  api_apiserver_id->register_user_service(api_userservicetrigger_id_3);
  automation_id_12 = new Automation<int32_t>(api_userservicetrigger_id_3);
  script_scriptexecuteaction_id_12 = new script::ScriptExecuteAction<script::Script<int>, int32_t>(set_deceleration);
  script_scriptexecuteaction_id_12->set_args([=](int32_t deceleration) -> int {
      #line 145 "packages/tmc5160_stepper_esp8266_d1_mini.yaml"
      return (float)deceleration;
  });
  automation_id_12->add_actions({script_scriptexecuteaction_id_12});
  api_userservicetrigger_id_4 = new api::UserServiceTrigger<int32_t>("set_stepper_target", {"target"});
  api_apiserver_id->register_user_service(api_userservicetrigger_id_4);
  automation_id_13 = new Automation<int32_t>(api_userservicetrigger_id_4);
  ...
  script_scriptexecuteaction_id_13 = new script::ScriptExecuteAction<script::Script<>, int32_t>(monitor_cover_movement);
  script_scriptexecuteaction_id_13->set_args();
  automation_id_13->add_actions({stepper_settargetaction_id, script_scriptexecuteaction_id_13});
  api_userservicetrigger_id_5 = new api::UserServiceTrigger<int32_t>("set_opening_clutch_backlash_adjustment", {"clutch_backlash_adjustment"});
  api_apiserver_id->register_user_service(api_userservicetrigger_id_5);
  automation_id_14 = new Automation<int32_t>(api_userservicetrigger_id_5);
  // sensor.template:
  //   platform: template
  //   id: dining_window_blind_max_speed
  //   name: Dining Window Blind Max Speed
  //   lambda: !lambda |-
  //     return (int)id(tmc_stepper).get_max_speed();
  //   update_interval: 4294967295
  //   disabled_by_default: false
  //   force_update: false
  //   accuracy_decimals: 1
  dining_window_blind_max_speed = new template_::TemplateSensor();
  App.register_sensor(dining_window_blind_max_speed);
  dining_window_blind_max_speed->set_name("Dining Window Blind Max Speed");
  dining_window_blind_max_speed->set_object_id("dining_window_blind_max_speed");
  dining_window_blind_max_speed->set_disabled_by_default(false);
  dining_window_blind_max_speed->set_accuracy_decimals(1);
  dining_window_blind_max_speed->set_force_update(false);
  dining_window_blind_max_speed->set_update_interval(4294967295UL);
  dining_window_blind_max_speed->set_component_source("template.sensor");
  App.register_component(dining_window_blind_max_speed);
  dining_window_blind_max_speed->set_template([=]() -> esphome::optional<float> {
      #line 153 "packages/tmc5160_stepper_esp8266_d1_mini.yaml"
      return (int)tmc_stepper->get_max_speed();
  });
  // sensor.template:
  //   platform: template
  //   id: dining_window_blind_acceleration
  //   name: Dining Window Blind Acceleration
  //   lambda: !lambda |-
  //     return (int)id(tmc_stepper).get_acceleration();
  //   update_interval: 4294967295
  //   disabled_by_default: false
  //   force_update: false
  //   accuracy_decimals: 1
  dining_window_blind_acceleration = new template_::TemplateSensor();
  App.register_sensor(dining_window_blind_acceleration);
  dining_window_blind_acceleration->set_name("Dining Window Blind Acceleration");
  dining_window_blind_acceleration->set_object_id("dining_window_blind_acceleration");
  dining_window_blind_acceleration->set_disabled_by_default(false);
  dining_window_blind_acceleration->set_accuracy_decimals(1);
  dining_window_blind_acceleration->set_force_update(false);
  dining_window_blind_acceleration->set_update_interval(4294967295UL);
  dining_window_blind_acceleration->set_component_source("template.sensor");
  App.register_component(dining_window_blind_acceleration);
  dining_window_blind_acceleration->set_template([=]() -> esphome::optional<float> {
      #line 159 "packages/tmc5160_stepper_esp8266_d1_mini.yaml"
      return (int)tmc_stepper->get_acceleration();
  });
  // sensor.template:
  //   platform: template
  //   id: dining_window_blind_deceleration
  //   name: Dining Window Blind Deceleration
  //   lambda: !lambda |-
  //     return (int)id(tmc_stepper).get_deceleration();
  //   update_interval: 4294967295
  //   disabled_by_default: false
  //   force_update: false
  //   accuracy_decimals: 1
  dining_window_blind_deceleration = new template_::TemplateSensor();
  App.register_sensor(dining_window_blind_deceleration);
  dining_window_blind_deceleration->set_name("Dining Window Blind Deceleration");
  dining_window_blind_deceleration->set_object_id("dining_window_blind_deceleration");
  dining_window_blind_deceleration->set_disabled_by_default(false);
  dining_window_blind_deceleration->set_accuracy_decimals(1);
  dining_window_blind_deceleration->set_force_update(false);
  dining_window_blind_deceleration->set_update_interval(4294967295UL);
  dining_window_blind_deceleration->set_component_source("template.sensor");
  App.register_component(dining_window_blind_deceleration);
  dining_window_blind_deceleration->set_template([=]() -> esphome::optional<float> {
      #line 165 "packages/tmc5160_stepper_esp8266_d1_mini.yaml"
      return (int)tmc_stepper->get_deceleration();
  });
  // sensor.template:
  //   platform: template
  //   id: dining_window_blind_current_position
  //   name: Dining Window Blind Current position
  //   lambda: !lambda |-
  //     return id(tmc_stepper).current_position;
  //   update_interval: 4294967295
  //   disabled_by_default: false
  //   force_update: false
  //   accuracy_decimals: 1
  dining_window_blind_current_position = new template_::TemplateSensor();
  App.register_sensor(dining_window_blind_current_position);
  dining_window_blind_current_position->set_name("Dining Window Blind Current position");
  dining_window_blind_current_position->set_object_id("dining_window_blind_current_position");
  dining_window_blind_current_position->set_disabled_by_default(false);
  dining_window_blind_current_position->set_accuracy_decimals(1);
  dining_window_blind_current_position->set_force_update(false);
  dining_window_blind_current_position->set_update_interval(4294967295UL);
  dining_window_blind_current_position->set_component_source("template.sensor");
  App.register_component(dining_window_blind_current_position);
  dining_window_blind_current_position->set_template([=]() -> esphome::optional<float> {
  ...
  //   platform: template
  //   id: dining_window_blind_closed_position
  //   name: Dining Window Blind Closed position
  //   lambda: !lambda |-
  //     return id(closed_position);
  //   update_interval: 4294967295
  //   disabled_by_default: false
  //   force_update: false
  //   accuracy_decimals: 1
  dining_window_blind_closed_position = new template_::TemplateSensor();
  App.register_sensor(dining_window_blind_closed_position);
  dining_window_blind_closed_position->set_name("Dining Window Blind Closed position");
  dining_window_blind_closed_position->set_object_id("dining_window_blind_closed_position");
  dining_window_blind_closed_position->set_disabled_by_default(false);
  dining_window_blind_closed_position->set_accuracy_decimals(1);
  dining_window_blind_closed_position->set_force_update(false);
  dining_window_blind_closed_position->set_update_interval(4294967295UL);
  dining_window_blind_closed_position->set_component_source("template.sensor");
  App.register_component(dining_window_blind_closed_position);
  // sensor.template:
  //   platform: template
  //   id: dining_window_blind_opening_counter
  //   name: Dining Window Blind Opening Counter
  //   lambda: !lambda |-
  //     return id(opening_counter);
  //   update_interval: 4294967295
  //   disabled_by_default: false
  //   force_update: false
  //   accuracy_decimals: 1
  dining_window_blind_opening_counter = new template_::TemplateSensor();
  App.register_sensor(dining_window_blind_opening_counter);
  dining_window_blind_opening_counter->set_name("Dining Window Blind Opening Counter");
  dining_window_blind_opening_counter->set_object_id("dining_window_blind_opening_counter");
  dining_window_blind_opening_counter->set_disabled_by_default(false);
  dining_window_blind_opening_counter->set_accuracy_decimals(1);
  dining_window_blind_opening_counter->set_force_update(false);
  dining_window_blind_opening_counter->set_update_interval(4294967295UL);
  dining_window_blind_opening_counter->set_component_source("template.sensor");
  App.register_component(dining_window_blind_opening_counter);
  // sensor.template:
  //   platform: template
  //   id: dining_window_blind_closing_counter
  //   name: Dining Window Blind Closing Counter
  //   lambda: !lambda |-
  //     return id(closing_counter);
  //   update_interval: 4294967295
  //   disabled_by_default: false
  //   force_update: false
  //   accuracy_decimals: 1
  dining_window_blind_closing_counter = new template_::TemplateSensor();
  App.register_sensor(dining_window_blind_closing_counter);
  dining_window_blind_closing_counter->set_name("Dining Window Blind Closing Counter");
  dining_window_blind_closing_counter->set_object_id("dining_window_blind_closing_counter");
  dining_window_blind_closing_counter->set_disabled_by_default(false);
  dining_window_blind_closing_counter->set_accuracy_decimals(1);
  dining_window_blind_closing_counter->set_force_update(false);
  dining_window_blind_closing_counter->set_update_interval(4294967295UL);
  dining_window_blind_closing_counter->set_component_source("template.sensor");
  App.register_component(dining_window_blind_closing_counter);
  // sensor.template:
  //   platform: template
  //   id: dining_window_blind_opening_clutch_backlash_adjustment
  //   name: Dining Window Blind Opening Clutch Backlash Adjustment
  //   lambda: !lambda |-
  //     return id(opening_clutch_backlash_adjustment);
  //   update_interval: 4294967295
  //   disabled_by_default: false
  //   force_update: false
  //   accuracy_decimals: 1
  dining_window_blind_opening_clutch_backlash_adjustment = new template_::TemplateSensor();
  App.register_sensor(dining_window_blind_opening_clutch_backlash_adjustment);
  dining_window_blind_opening_clutch_backlash_adjustment->set_name("Dining Window Blind Opening Clutch Backlash Adjustment");
  dining_window_blind_opening_clutch_backlash_adjustment->set_object_id("dining_window_blind_opening_clutch_backlash_adjustment");
  dining_window_blind_opening_clutch_backlash_adjustment->set_disabled_by_default(false);
  dining_window_blind_opening_clutch_backlash_adjustment->set_accuracy_decimals(1);
  dining_window_blind_opening_clutch_backlash_adjustment->set_force_update(false);
  dining_window_blind_opening_clutch_backlash_adjustment->set_update_interval(4294967295UL);
  dining_window_blind_opening_clutch_backlash_adjustment->set_component_source("template.sensor");
  App.register_component(dining_window_blind_opening_clutch_backlash_adjustment);
  // sensor.wifi_signal:
  //   platform: wifi_signal
  //   name: Dining Window Blind WiFi Strength
  //   update_interval: 60s
  //   disabled_by_default: false
  //   force_update: false
  ...
  wifi_signal_wifisignalsensor_id->set_name("Dining Window Blind WiFi Strength");
  wifi_signal_wifisignalsensor_id->set_object_id("dining_window_blind_wifi_strength");
  ...
  // sensor.uptime:
  //   platform: uptime
  //   name: Dining Window Blind Uptime
  ...
  uptime_human_readable->set_name("Dining Window Blind Uptime");
  uptime_human_readable->set_object_id("dining_window_blind_uptime");
  ...
  automation_id_18 = new Automation<float>(sensor_sensorrawstatetrigger_id);
  // cover.template:
  //   platform: template
  //   id: blind_cover
  //   device_class: blind
  ...
  blind_cover->set_name("Dining Window Blind");
  blind_cover->set_object_id("dining_window_blind");
  ...
  automation_id_19 = new Automation<>(blind_cover->get_open_trigger());
  ...
  uptime_human->set_name("Dining Window Blind Uptime");
  uptime_human->set_object_id("dining_window_blind_uptime");
  ...
  // md5:
  lambdaaction_id = new LambdaAction<int>([=](int speed) -> void {
      #line 67 "packages/tmc5160_stepper_esp8266_d1_mini.yaml"
      tmc_stepper->set_max_speed(speed);
  });
  ...
  automation_id_18->add_actions({text_sensor_textsensorpublishaction_id});
  ...
  //   initial_value: '1000'
  //   restore_value: true
  saved_speed = new globals::RestoringGlobalsComponent<float>(1000);
  saved_speed->set_component_source("globals");
  App.register_component(saved_speed);
  saved_speed->set_name_hash(3381807057UL);
  // globals:
  //   id: saved_acceleration
  //   type: float
  //   initial_value: '1500'
  //   restore_value: true
  saved_acceleration = new globals::RestoringGlobalsComponent<float>(1500);
  saved_acceleration->set_component_source("globals");
  App.register_component(saved_acceleration);
  saved_acceleration->set_name_hash(1417885559);
  // globals:
  //   id: saved_deceleration
  //   type: float
  //   initial_value: '1500'
  //   restore_value: true
  saved_deceleration = new globals::RestoringGlobalsComponent<float>(1500);
  saved_deceleration->set_component_source("globals");
  App.register_component(saved_deceleration);
  saved_deceleration->set_name_hash(4240703612UL);
  // globals:
  //   id: open_position
  //   type: int
  //   initial_value: '0'
  ...
  //   initial_value: '8300'
  //   restore_value: false
  closed_position = new globals::GlobalsComponent<int>(8300);
  ...
  //   initial_value: '10'
  //   restore_value: true
  opening_clutch_backlash_adjustment = new globals::RestoringGlobalsComponent<int>(10);
  ...
  globals_globalvarsetaction_id = new globals::GlobalVarSetAction<globals::RestoringGlobalsComponent<float>, int>(saved_speed);
  globals_globalvarsetaction_id->set_value([=](int speed) {
      #line 70 "packages/tmc5160_stepper_esp8266_d1_mini.yaml"
      return speed;
  });
  sensor_sensorpublishaction_id_5 = new sensor::SensorPublishAction<int>(dining_window_blind_max_speed);
  sensor_sensorpublishaction_id_5->set_state([=](int speed) -> float {
      #line 74 "packages/tmc5160_stepper_esp8266_d1_mini.yaml"
      return speed;
  });
  automation_id_2->add_actions({lambdaaction_id, globals_globalvarsetaction_id, sensor_sensorpublishaction_id_5});
  automation_id_3 = new Automation<int>(set_acceleration);
  lambdaaction_id_2 = new LambdaAction<int>([=](int acceleration) -> void {
      #line 79 "packages/tmc5160_stepper_esp8266_d1_mini.yaml"
      tmc_stepper->set_acceleration(acceleration);
  });
  globals_globalvarsetaction_id_2 = new globals::GlobalVarSetAction<globals::RestoringGlobalsComponent<float>, int>(saved_acceleration);
  globals_globalvarsetaction_id_2->set_value([=](int acceleration) {
      #line 82 "packages/tmc5160_stepper_esp8266_d1_mini.yaml"
      return acceleration;
  });
  sensor_sensorpublishaction_id_6 = new sensor::SensorPublishAction<int>(dining_window_blind_acceleration);
  sensor_sensorpublishaction_id_6->set_state([=](int acceleration) -> float {
      #line 86 "packages/tmc5160_stepper_esp8266_d1_mini.yaml"
      return acceleration;
  });
  automation_id_3->add_actions({lambdaaction_id_2, globals_globalvarsetaction_id_2, sensor_sensorpublishaction_id_6});
  automation_id_4 = new Automation<int>(set_deceleration);
  lambdaaction_id_3 = new LambdaAction<int>([=](int deceleration) -> void {
      #line 91 "packages/tmc5160_stepper_esp8266_d1_mini.yaml"
      tmc_stepper->set_deceleration(deceleration);
  });
  globals_globalvarsetaction_id_3 = new globals::GlobalVarSetAction<globals::RestoringGlobalsComponent<float>, int>(saved_deceleration);
  globals_globalvarsetaction_id_3->set_value([=](int deceleration) {
      #line 94 "packages/tmc5160_stepper_esp8266_d1_mini.yaml"
      return deceleration;
  });
  sensor_sensorpublishaction_id_7 = new sensor::SensorPublishAction<int>(dining_window_blind_deceleration);
  sensor_sensorpublishaction_id_7->set_state([=](int deceleration) -> float {
      #line 98 "packages/tmc5160_stepper_esp8266_d1_mini.yaml"
      return deceleration;
  });
  automation_id_4->add_actions({lambdaaction_id_3, globals_globalvarsetaction_id_3, sensor_sensorpublishaction_id_7});
  automation_id_5 = new Automation<>(record_stepper_position);
  globals_globalvarsetaction_id_4 = new globals::GlobalVarSetAction<globals::RestoringGlobalsComponent<int>>(saved_position);
  globals_globalvarsetaction_id_4->set_value([=]() {
      #line 110 "packages/roller_blind.yaml"
      return tmc_stepper->current_position;
  });
  automation_id_5->add_actions({globals_globalvarsetaction_id_4});
  automation_id_6 = new Automation<int>(set_stepper_position);
  ...
  script_scriptexecuteaction_id_6 = new script::ScriptExecuteAction<script::Script<>, int>(record_stepper_position);
  script_scriptexecuteaction_id_6->set_args();
  automation_id_6->add_actions({lambdaaction_id_4, script_scriptexecuteaction_id_6});
  automation_id_7 = new Automation<>(publish_cover_position);
  ...
  sensor_sensorpublishaction_id_8 = new sensor::SensorPublishAction<>(dining_window_blind_current_position);
  sensor_sensorpublishaction_id_8->set_state([=]() -> float {
      #line 127 "packages/roller_blind.yaml"
      return tmc_stepper->current_position;
  });
  automation_id_7->add_actions({cover_coverpublishaction_id, sensor_sensorpublishaction_id_8});
  automation_id_8 = new Automation<>(publish_cover_state);
  lambdaaction_id_5 = new LambdaAction<>([=]() -> void {
      ...
      if (tmc_stepper->has_reached_target() && blind_cover->current_operation != COVER_OPERATION_IDLE) {
        ...
        dining_window_blind_closing_counter->publish_state(closing_counter->value());
      }
        ...
        dining_window_blind_opening_counter->publish_state(opening_counter->value());
      }
  });
  automation_id_8->add_actions({lambdaaction_id_5});
  automation_id_9 = new Automation<>(monitor_cover_movement);
  ...
  script_scriptexecuteaction_id_7 = new script::ScriptExecuteAction<script::Script<>>(publish_cover_state);
  ...
  whileaction_id->add_then({script_scriptexecuteaction_id_7, delayaction_id});
  script_scriptexecuteaction_id_8 = new script::ScriptExecuteAction<script::Script<>>(publish_cover_position);
  script_scriptexecuteaction_id_8->set_args();
  script_scriptexecuteaction_id_9 = new script::ScriptExecuteAction<script::Script<>>(record_stepper_position);
  ...
  automation_id_9->add_actions({whileaction_id, script_scriptexecuteaction_id_8, script_scriptexecuteaction_id_9, cover_coverpublishaction_id_2});
  lambdaaction_id_6 = new LambdaAction<int32_t>([=](int32_t clutch_backlash_adjustment) -> void {
      #line 44 "packages/roller_blind.yaml"
      opening_clutch_backlash_adjustment->value() = clutch_backlash_adjustment;
      dining_window_blind_opening_clutch_backlash_adjustment->publish_state(opening_clutch_backlash_adjustment->value());
  });
  automation_id_14->add_actions({lambdaaction_id_6});
  api_userservicetrigger_id_6 = new api::UserServiceTrigger<int32_t>("set_stepper_position", {"position"});
  api_apiserver_id->register_user_service(api_userservicetrigger_id_6);
  automation_id_15 = new Automation<int32_t>(api_userservicetrigger_id_6);
  lambdacondition_id_2 = new LambdaCondition<int32_t>([=](int32_t position) -> bool {
      #line 55 "packages/roller_blind.yaml"
      return tmc_stepper->get_is_driver_enabled();
  });
  ifaction_id = new IfAction<int32_t>(lambdacondition_id_2);
  ...
  script_scriptexecuteaction_id_14 = new script::ScriptExecuteAction<script::Script<int>, int32_t>(set_stepper_position);
  script_scriptexecuteaction_id_14->set_args([=](int32_t position) -> int {
      #line 65 "packages/roller_blind.yaml"
      return position;
  });
  script_scriptexecuteaction_id_15 = new script::ScriptExecuteAction<script::Script<>, int32_t>(publish_cover_position);
  script_scriptexecuteaction_id_15->set_args();
  script_scriptexecuteaction_id_16 = new script::ScriptExecuteAction<script::Script<>, int32_t>(publish_cover_state);
  script_scriptexecuteaction_id_16->set_args();
  ifaction_id->add_else({script_scriptexecuteaction_id_14, script_scriptexecuteaction_id_15, script_scriptexecuteaction_id_16});
  automation_id_15->add_actions({ifaction_id});
  api_userservicetrigger_id_7 = new api::UserServiceTrigger<>("reset_counters", {});
  api_apiserver_id->register_user_service(api_userservicetrigger_id_7);
  automation_id_16 = new Automation<>(api_userservicetrigger_id_7);
  ...
  ifaction_id_2->add_else({lambdaaction_id_7});
  automation_id_16->add_actions({ifaction_id_2});
  api_userservicetrigger_id_8 = new api::UserServiceTrigger<std::string>("log_message", {"message"});
  api_apiserver_id->register_user_service(api_userservicetrigger_id_8);
  automation_id_17 = new Automation<std::string>(api_userservicetrigger_id_8);
  lambdaaction_id_8 = new LambdaAction<std::string>([=](std::string message) -> void {
  ...
  automation_id_17->add_actions({lambdaaction_id_8, api_homeassistantservicecallaction_id_3});
  dining_window_blind_closed_position->set_template([=]() -> esphome::optional<float> {
      #line 265 "packages/roller_blind.yaml"
      return closed_position->value();
  });
  dining_window_blind_opening_counter->set_template([=]() -> esphome::optional<float> {
      #line 271 "packages/roller_blind.yaml"
      return opening_counter->value();
  });
  dining_window_blind_closing_counter->set_template([=]() -> esphome::optional<float> {
      #line 277 "packages/roller_blind.yaml"
      return closing_counter->value();
  });
  dining_window_blind_opening_clutch_backlash_adjustment->set_template([=]() -> esphome::optional<float> {
  ...
  ifaction_id_3->add_then({lambdaaction_id_10});
  ...
  script_scriptexecuteaction_id_17 = new script::ScriptExecuteAction<script::Script<>>(monitor_cover_movement);
  script_scriptexecuteaction_id_17->set_args();
  automation_id_19->add_actions({lambdaaction_id_9, ifaction_id_3, stepper_settargetaction_id_2, script_scriptexecuteaction_id_17});
  automation_id_20 = new Automation<>(blind_cover->get_close_trigger());
  ...
  script_scriptexecuteaction_id_18 = new script::ScriptExecuteAction<script::Script<>>(monitor_cover_movement);
  script_scriptexecuteaction_id_18->set_args();
  automation_id_20->add_actions({lambdaaction_id_11, stepper_settargetaction_id_3, script_scriptexecuteaction_id_18});
  automation_id_22 = new Automation<>(blind_cover->get_stop_trigger());
  lambdaaction_id_16 = new LambdaAction<>([=]() -> void {
  ...
  script_scriptexecuteaction_id_20 = new script::ScriptExecuteAction<script::Script<>>(monitor_cover_movement);
  script_scriptexecuteaction_id_20->set_args();
  automation_id_22->add_actions({lambdaaction_id_16, lambdaaction_id_17, script_scriptexecuteaction_id_20});
  blind_cover->set_has_stop(true);
  automation_id_21 = new Automation<float>(blind_cover->get_position_trigger());
  lambdaaction_id_12 = new LambdaAction<float>([=](float pos) -> void {
      ESP_LOGD("main", "Setting position");
  });
  lambdaaction_id_13 = new LambdaAction<float>([=](float pos) -> void {
  ...
  lambdaaction_id_14 = new LambdaAction<float>([=](float pos) -> void {
      ESP_LOGD("main", "Adjusting target for clutch backlash");
  });
  lambdaaction_id_15 = new LambdaAction<float>([=](float pos) -> void {
      #line 240 "packages/roller_blind.yaml"
      int adjusted_pos = tmc_stepper->current_position + opening_clutch_backlash_adjustment->value();
      tmc_stepper->set_position(adjusted_pos);
  });
  ifaction_id_4->add_then({lambdaaction_id_14, lambdaaction_id_15});
  ...
  script_scriptexecuteaction_id_19 = new script::ScriptExecuteAction<script::Script<>, float>(monitor_cover_movement);
  script_scriptexecuteaction_id_19->set_args();
  automation_id_21->add_actions({lambdaaction_id_12, lambdaaction_id_13, ifaction_id_5, stepper_settargetaction_id_4, script_scriptexecuteaction_id_19});
  ...
  blind_cover->set_has_position(true);
  script_scriptexecuteaction_id = new script::ScriptExecuteAction<script::Script<int>>(set_speed);
  script_scriptexecuteaction_id->set_args([=]() -> int {
      #line 40 "packages/tmc5160_stepper_esp8266_d1_mini.yaml"
      return saved_speed->value();
  });
  script_scriptexecuteaction_id_2 = new script::ScriptExecuteAction<script::Script<int>>(set_acceleration);
  script_scriptexecuteaction_id_2->set_args([=]() -> int {
      #line 43 "packages/tmc5160_stepper_esp8266_d1_mini.yaml"
      return saved_acceleration->value();
  });
  script_scriptexecuteaction_id_3 = new script::ScriptExecuteAction<script::Script<int>>(set_deceleration);
  script_scriptexecuteaction_id_3->set_args([=]() -> int {
      #line 46 "packages/tmc5160_stepper_esp8266_d1_mini.yaml"
      return saved_deceleration->value();
  });
  script_scriptexecuteaction_id_4 = new script::ScriptExecuteAction<script::Script<int>>(set_stepper_position);
  script_scriptexecuteaction_id_4->set_args([=]() -> int {
      #line 9 "packages/roller_blind.yaml"
      return saved_position->value();
  });
  script_scriptexecuteaction_id_5 = new script::ScriptExecuteAction<script::Script<>>(publish_cover_position);
  script_scriptexecuteaction_id_5->set_args();
  sensor_sensorpublishaction_id = new sensor::SensorPublishAction<>(dining_window_blind_closed_position);
  sensor_sensorpublishaction_id->set_state([=]() -> float {
      #line 14 "packages/roller_blind.yaml"
      return closed_position->value();
  });
  sensor_sensorpublishaction_id_2 = new sensor::SensorPublishAction<>(dining_window_blind_closing_counter);
  sensor_sensorpublishaction_id_2->set_state([=]() -> float {
      #line 17 "packages/roller_blind.yaml"
      return closing_counter->value();
  });
  sensor_sensorpublishaction_id_3 = new sensor::SensorPublishAction<>(dining_window_blind_opening_counter);
  sensor_sensorpublishaction_id_3->set_state([=]() -> float {
      #line 20 "packages/roller_blind.yaml"
      return opening_counter->value();
  });
  sensor_sensorpublishaction_id_4 = new sensor::SensorPublishAction<>(dining_window_blind_opening_clutch_backlash_adjustment);
  sensor_sensorpublishaction_id_4->set_state([=]() -> float {
      #line 23 "packages/roller_blind.yaml"
      return opening_clutch_backlash_adjustment->value();
  });
  automation_id->add_actions({script_scriptexecuteaction_id, script_scriptexecuteaction_id_2, script_scriptexecuteaction_id_3, script_scriptexecuteaction_id_4, script_scriptexecuteaction_id_5, sensor_sensorpublishaction_id, sensor_sensorpublishaction_id_2, sensor_sensorpublishaction_id_3, sensor_sensorpublishaction_id_4});
