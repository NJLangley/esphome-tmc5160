...
void setup() {
  ...
  //   build_path: build/breadboard-fan
  //   friendly_name: ''
  //   area: ''
  //   platformio_options: {}
  //   includes: []
  ...
  App.pre_setup("breadboard-fan", "", "", "", __DATE__ ", " __TIME__, false);
  // sensor:
  // fan:
  // number:
  // text_sensor:
  ...
  //     id: wifi_wifiap_id_2
  //     priority: 0.0
  //   use_address: breadboard-fan.local
  wifi_wificomponent_id = new wifi::WiFiComponent();
  wifi_wificomponent_id->set_use_address("breadboard-fan.local");
  {
  ...
  output_setlevelaction_id_7->set_level([=](float x) -> float {
      #line 157 "packages/fan_4_pin.yaml"
      return x/100;
  });
  ...
  output_setlevelaction_id_5->set_level([=]() -> float {
      #line 121 "packages/fan_4_pin.yaml"
  ...
  output_setlevelaction_id_6->set_level([=]() -> float {
      #line 128 "packages/fan_4_pin.yaml"
