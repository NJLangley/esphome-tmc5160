...
Automation<float> *automation_id_23;
...
template_::TemplateSensor *c_bedroom_window_blind_max_speed;
template_::TemplateSensor *c_bedroom_window_blind_acceleration;
template_::TemplateSensor *c_bedroom_window_blind_deceleration;
template_::TemplateSensor *c_bedroom_window_blind_current_position;
template_::TemplateSensor *c_bedroom_window_blind_closed_position;
template_::TemplateSensor *c_bedroom_window_blind_opening_counter;
template_::TemplateSensor *c_bedroom_window_blind_closing_counter;
template_::TemplateSensor *c_bedroom_window_blind_opening_clutch_backlash_adjustment;
...
Automation<float> *automation_id_20;
...
void setup() {
  ...
  //     priority: 600.0
  //   build_path: build/c-bedroom-window-blind
  //   friendly_name: ''
  //   area: ''
  //   platformio_options: {}
  //   includes: []
  ...
  App.pre_setup("c-bedroom-window-blind", "", "", "", __DATE__ ", " __TIME__, false);
  // stepper:
  // sensor:
  // cover:
  // logger:
  ...
  // wifi:
  //   manual_ip:
  //     static_ip: !secret 'wifi_static_ip_c_bedroom_window_blind'
  //     gateway: !secret 'wifi_gateway'
  //     subnet: 255.255.255.0
  //     dns1: 0.0.0.0
  //     dns2: 0.0.0.0
  //   ap:
  //     ssid: '{c_bedroom_window_blind}'
  //     password: password
  //     id: wifi_wifiap_id
  //     ap_timeout: 1min
  ...
  //     id: wifi_wifiap_id_2
  //     priority: 0.0
  //   use_address: 192.168.66.28
  wifi_wificomponent_id = new wifi::WiFiComponent();
  wifi_wificomponent_id->set_use_address("192.168.66.28");
  {
  ...
  wifi_wifiap_id_2.set_manual_ip(wifi::ManualIP{
      .static_ip = network::IPAddress(192, 168, 66, 28),
  ...
  wifi_wifiap_id.set_ssid("{c_bedroom_window_blind}");
  ...
  //         id(c_bedroom_window_blind_opening_clutch_backlash_adjustment).publish_state(id(opening_counter));
  ...
  //             id(c_bedroom_window_blind_opening_counter).publish_state(id(opening_counter));
  //   
  //             id(closing_counter) = 0;
  //             id(c_bedroom_window_blind_closing_counter).publish_state(id(closing_counter));
  ...
  // substitutions:
  //   device_name: c-bedroom-window-blind
  //   friendly_name: C Bedroom Window Blind
  //   node_name: c_bedroom_window_blind
  //   wifi_static_ip: !secret 'wifi_static_ip_c_bedroom_window_blind'
  ...
  //     - sensor.template.publish:
  //         id: c_bedroom_window_blind_max_speed
  //         state: !lambda |-
  //           return speed;
  ...
  //     - sensor.template.publish:
  //         id: c_bedroom_window_blind_acceleration
  //         state: !lambda |-
  //           return acceleration;
  ...
  //     - sensor.template.publish:
  //         id: c_bedroom_window_blind_deceleration
  //         state: !lambda |-
  //           return deceleration;
  ...
  //     - sensor.template.publish:
  //         id: c_bedroom_window_blind_current_position
  //         state: !lambda |-
  //           return id(tmc_stepper).current_position;
  ...
  tmc_stepper->set_acceleration(2000.0f);
  tmc_stepper->set_deceleration(2000.0f);
  ...
  script_scriptexecuteaction_id_10->set_args([=](int32_t speed) -> int {
      #line 118 "packages/tmc5160_stepper_esp8266_d1_mini.yaml"
      return (float)speed;
  });
  ...
  script_scriptexecuteaction_id_11->set_args([=](int32_t acceleration) -> int {
      #line 126 "packages/tmc5160_stepper_esp8266_d1_mini.yaml"
      return (float)acceleration;
  });
  ...
  script_scriptexecuteaction_id_12->set_args([=](int32_t deceleration) -> int {
      #line 134 "packages/tmc5160_stepper_esp8266_d1_mini.yaml"
      return (float)deceleration;
  });
  ...
  //   platform: template
  //   id: c_bedroom_window_blind_max_speed
  //   name: C Bedroom Window Blind Max Speed
  //   lambda: !lambda |-
  ...
  //   force_update: false
  //   accuracy_decimals: 1
  c_bedroom_window_blind_max_speed = new template_::TemplateSensor();
  App.register_sensor(c_bedroom_window_blind_max_speed);
  c_bedroom_window_blind_max_speed->set_name("C Bedroom Window Blind Max Speed");
  c_bedroom_window_blind_max_speed->set_object_id("c_bedroom_window_blind_max_speed");
  c_bedroom_window_blind_max_speed->set_disabled_by_default(false);
  c_bedroom_window_blind_max_speed->set_accuracy_decimals(1);
  c_bedroom_window_blind_max_speed->set_force_update(false);
  c_bedroom_window_blind_max_speed->set_update_interval(4294967295UL);
  c_bedroom_window_blind_max_speed->set_component_source("template.sensor");
  App.register_component(c_bedroom_window_blind_max_speed);
  c_bedroom_window_blind_max_speed->set_template([=]() -> optional<float> {
      #line 142 "packages/tmc5160_stepper_esp8266_d1_mini.yaml"
      return (int)tmc_stepper->get_max_speed();
  });
  // sensor.template:
  //   platform: template
  //   id: c_bedroom_window_blind_acceleration
  //   name: C Bedroom Window Blind Acceleration
  //   lambda: !lambda |-
  ...
  //   force_update: false
  //   accuracy_decimals: 1
  c_bedroom_window_blind_acceleration = new template_::TemplateSensor();
  App.register_sensor(c_bedroom_window_blind_acceleration);
  c_bedroom_window_blind_acceleration->set_name("C Bedroom Window Blind Acceleration");
  c_bedroom_window_blind_acceleration->set_object_id("c_bedroom_window_blind_acceleration");
  c_bedroom_window_blind_acceleration->set_disabled_by_default(false);
  c_bedroom_window_blind_acceleration->set_accuracy_decimals(1);
  c_bedroom_window_blind_acceleration->set_force_update(false);
  c_bedroom_window_blind_acceleration->set_update_interval(4294967295UL);
  c_bedroom_window_blind_acceleration->set_component_source("template.sensor");
  App.register_component(c_bedroom_window_blind_acceleration);
  c_bedroom_window_blind_acceleration->set_template([=]() -> optional<float> {
      #line 148 "packages/tmc5160_stepper_esp8266_d1_mini.yaml"
      return (int)tmc_stepper->get_acceleration();
  });
  // sensor.template:
  //   platform: template
  //   id: c_bedroom_window_blind_deceleration
  //   name: C Bedroom Window Blind Deceleration
  //   lambda: !lambda |-
  ...
  //   force_update: false
  //   accuracy_decimals: 1
  c_bedroom_window_blind_deceleration = new template_::TemplateSensor();
  App.register_sensor(c_bedroom_window_blind_deceleration);
  c_bedroom_window_blind_deceleration->set_name("C Bedroom Window Blind Deceleration");
  c_bedroom_window_blind_deceleration->set_object_id("c_bedroom_window_blind_deceleration");
  c_bedroom_window_blind_deceleration->set_disabled_by_default(false);
  c_bedroom_window_blind_deceleration->set_accuracy_decimals(1);
  c_bedroom_window_blind_deceleration->set_force_update(false);
  c_bedroom_window_blind_deceleration->set_update_interval(4294967295UL);
  c_bedroom_window_blind_deceleration->set_component_source("template.sensor");
  App.register_component(c_bedroom_window_blind_deceleration);
  c_bedroom_window_blind_deceleration->set_template([=]() -> optional<float> {
      #line 154 "packages/tmc5160_stepper_esp8266_d1_mini.yaml"
      return (int)tmc_stepper->get_deceleration();
  });
  // sensor.template:
  //   platform: template
  //   id: c_bedroom_window_blind_current_position
  //   name: C Bedroom Window Blind Current position
  //   lambda: !lambda |-
  //     return id(tmc_stepper).current_position;
  //   update_interval: 4294967295
  //   disabled_by_default: false
  //   force_update: false
  //   accuracy_decimals: 1
  c_bedroom_window_blind_current_position = new template_::TemplateSensor();
  App.register_sensor(c_bedroom_window_blind_current_position);
  c_bedroom_window_blind_current_position->set_name("C Bedroom Window Blind Current position");
  c_bedroom_window_blind_current_position->set_object_id("c_bedroom_window_blind_current_position");
  c_bedroom_window_blind_current_position->set_disabled_by_default(false);
  c_bedroom_window_blind_current_position->set_accuracy_decimals(1);
  c_bedroom_window_blind_current_position->set_force_update(false);
  c_bedroom_window_blind_current_position->set_update_interval(4294967295UL);
  c_bedroom_window_blind_current_position->set_component_source("template.sensor");
  App.register_component(c_bedroom_window_blind_current_position);
  c_bedroom_window_blind_current_position->set_template([=]() -> optional<float> {
  ...
  //   platform: template
  //   id: c_bedroom_window_blind_closed_position
  //   name: C Bedroom Window Blind Closed position
  //   lambda: !lambda |-
  //     return id(closed_position);
  //   update_interval: 4294967295
  //   disabled_by_default: false
  //   force_update: false
  //   accuracy_decimals: 1
  c_bedroom_window_blind_closed_position = new template_::TemplateSensor();
  App.register_sensor(c_bedroom_window_blind_closed_position);
  c_bedroom_window_blind_closed_position->set_name("C Bedroom Window Blind Closed position");
  c_bedroom_window_blind_closed_position->set_object_id("c_bedroom_window_blind_closed_position");
  c_bedroom_window_blind_closed_position->set_disabled_by_default(false);
  c_bedroom_window_blind_closed_position->set_accuracy_decimals(1);
  c_bedroom_window_blind_closed_position->set_force_update(false);
  c_bedroom_window_blind_closed_position->set_update_interval(4294967295UL);
  c_bedroom_window_blind_closed_position->set_component_source("template.sensor");
  App.register_component(c_bedroom_window_blind_closed_position);
  // sensor.template:
  //   platform: template
  //   id: c_bedroom_window_blind_opening_counter
  //   name: C Bedroom Window Blind Opening Counter
  //   lambda: !lambda |-
  //     return id(opening_counter);
  //   update_interval: 4294967295
  //   disabled_by_default: false
  //   force_update: false
  //   accuracy_decimals: 1
  c_bedroom_window_blind_opening_counter = new template_::TemplateSensor();
  App.register_sensor(c_bedroom_window_blind_opening_counter);
  c_bedroom_window_blind_opening_counter->set_name("C Bedroom Window Blind Opening Counter");
  c_bedroom_window_blind_opening_counter->set_object_id("c_bedroom_window_blind_opening_counter");
  c_bedroom_window_blind_opening_counter->set_disabled_by_default(false);
  c_bedroom_window_blind_opening_counter->set_accuracy_decimals(1);
  c_bedroom_window_blind_opening_counter->set_force_update(false);
  c_bedroom_window_blind_opening_counter->set_update_interval(4294967295UL);
  c_bedroom_window_blind_opening_counter->set_component_source("template.sensor");
  App.register_component(c_bedroom_window_blind_opening_counter);
  // sensor.template:
  //   platform: template
  //   id: c_bedroom_window_blind_closing_counter
  //   name: C Bedroom Window Blind Closing Counter
  //   lambda: !lambda |-
  //     return id(closing_counter);
  //   update_interval: 4294967295
  //   disabled_by_default: false
  //   force_update: false
  //   accuracy_decimals: 1
  c_bedroom_window_blind_closing_counter = new template_::TemplateSensor();
  App.register_sensor(c_bedroom_window_blind_closing_counter);
  c_bedroom_window_blind_closing_counter->set_name("C Bedroom Window Blind Closing Counter");
  c_bedroom_window_blind_closing_counter->set_object_id("c_bedroom_window_blind_closing_counter");
  c_bedroom_window_blind_closing_counter->set_disabled_by_default(false);
  c_bedroom_window_blind_closing_counter->set_accuracy_decimals(1);
  c_bedroom_window_blind_closing_counter->set_force_update(false);
  c_bedroom_window_blind_closing_counter->set_update_interval(4294967295UL);
  c_bedroom_window_blind_closing_counter->set_component_source("template.sensor");
  App.register_component(c_bedroom_window_blind_closing_counter);
  // sensor.template:
  //   platform: template
  //   id: c_bedroom_window_blind_opening_clutch_backlash_adjustment
  //   name: C Bedroom Window Blind Opening Clutch Backlash Adjustment
  //   lambda: !lambda |-
  //     return id(opening_clutch_backlash_adjustment);
  //   update_interval: 4294967295
  //   disabled_by_default: false
  //   force_update: false
  //   accuracy_decimals: 1
  c_bedroom_window_blind_opening_clutch_backlash_adjustment = new template_::TemplateSensor();
  App.register_sensor(c_bedroom_window_blind_opening_clutch_backlash_adjustment);
  c_bedroom_window_blind_opening_clutch_backlash_adjustment->set_name("C Bedroom Window Blind Opening Clutch Backlash Adjustment");
  c_bedroom_window_blind_opening_clutch_backlash_adjustment->set_object_id("c_bedroom_window_blind_opening_clutch_backlash_adjustment");
  c_bedroom_window_blind_opening_clutch_backlash_adjustment->set_disabled_by_default(false);
  c_bedroom_window_blind_opening_clutch_backlash_adjustment->set_accuracy_decimals(1);
  c_bedroom_window_blind_opening_clutch_backlash_adjustment->set_force_update(false);
  c_bedroom_window_blind_opening_clutch_backlash_adjustment->set_update_interval(4294967295UL);
  c_bedroom_window_blind_opening_clutch_backlash_adjustment->set_component_source("template.sensor");
  App.register_component(c_bedroom_window_blind_opening_clutch_backlash_adjustment);
  // sensor.uptime:
  //   platform: uptime
  //   name: Uptime Sensor
  //   disabled_by_default: false
  ...
  blind_cover->set_name("C Bedroom Window Blind");
  blind_cover->set_object_id("c_bedroom_window_blind");
  blind_cover->set_disabled_by_default(false);
  blind_cover->set_device_class("blind");
  automation_id_18 = new Automation<>(blind_cover->get_open_trigger());
  ...
  lambdaaction_id = new LambdaAction<int>([=](int speed) -> void {
      #line 56 "packages/tmc5160_stepper_esp8266_d1_mini.yaml"
  ...
  //   initial_value: '2000'
  //   restore_value: true
  saved_acceleration = new globals::RestoringGlobalsComponent<float>(2000);
  ...
  //   initial_value: '2000'
  //   restore_value: true
  saved_deceleration = new globals::RestoringGlobalsComponent<float>(2000);
  ...
  globals_globalvarsetaction_id->set_value([=](int speed) {
      #line 59 "packages/tmc5160_stepper_esp8266_d1_mini.yaml"
      return speed;
  });
  sensor_sensorpublishaction_id_5 = new sensor::SensorPublishAction<int>(c_bedroom_window_blind_max_speed);
  sensor_sensorpublishaction_id_5->set_state([=](int speed) -> float {
      #line 63 "packages/tmc5160_stepper_esp8266_d1_mini.yaml"
      return speed;
  });
  ...
  lambdaaction_id_2 = new LambdaAction<int>([=](int acceleration) -> void {
      #line 68 "packages/tmc5160_stepper_esp8266_d1_mini.yaml"
  ...
  globals_globalvarsetaction_id_2->set_value([=](int acceleration) {
      #line 71 "packages/tmc5160_stepper_esp8266_d1_mini.yaml"
      return acceleration;
  });
  sensor_sensorpublishaction_id_6 = new sensor::SensorPublishAction<int>(c_bedroom_window_blind_acceleration);
  sensor_sensorpublishaction_id_6->set_state([=](int acceleration) -> float {
      #line 75 "packages/tmc5160_stepper_esp8266_d1_mini.yaml"
      return acceleration;
  });
  ...
  lambdaaction_id_3 = new LambdaAction<int>([=](int deceleration) -> void {
      #line 80 "packages/tmc5160_stepper_esp8266_d1_mini.yaml"
  ...
  globals_globalvarsetaction_id_3->set_value([=](int deceleration) {
      #line 83 "packages/tmc5160_stepper_esp8266_d1_mini.yaml"
      return deceleration;
  });
  sensor_sensorpublishaction_id_7 = new sensor::SensorPublishAction<int>(c_bedroom_window_blind_deceleration);
  sensor_sensorpublishaction_id_7->set_state([=](int deceleration) -> float {
      #line 87 "packages/tmc5160_stepper_esp8266_d1_mini.yaml"
      return deceleration;
  });
  ...
  sensor_sensorpublishaction_id_8 = new sensor::SensorPublishAction<>(c_bedroom_window_blind_current_position);
  ...
  lambdaaction_id_5 = new LambdaAction<>([=]() -> void {
      ...
      if (tmc_stepper->has_reached_target() && blind_cover->current_operation != COVER_OPERATION_IDLE) {
        ...
        c_bedroom_window_blind_closing_counter->publish_state(closing_counter->value());
      }
        ...
        c_bedroom_window_blind_opening_counter->publish_state(opening_counter->value());
      }
  });
  ...
  lambdaaction_id_6 = new LambdaAction<int32_t>([=](int32_t clutch_backlash_adjustment) -> void {
      ...
      c_bedroom_window_blind_opening_clutch_backlash_adjustment->publish_state(opening_counter->value());
  });
  ...
  c_bedroom_window_blind_closed_position->set_template([=]() -> optional<float> {
      #line 265 "packages/roller_blind.yaml"
      return closed_position->value();
  });
  c_bedroom_window_blind_opening_counter->set_template([=]() -> optional<float> {
      #line 271 "packages/roller_blind.yaml"
      return opening_counter->value();
  });
  c_bedroom_window_blind_closing_counter->set_template([=]() -> optional<float> {
      #line 277 "packages/roller_blind.yaml"
      return closing_counter->value();
  });
  c_bedroom_window_blind_opening_clutch_backlash_adjustment->set_template([=]() -> optional<float> {
  ...
  automation_id_18->add_actions({lambdaaction_id_9, ifaction_id_3, stepper_settargetaction_id_2, script_scriptexecuteaction_id_17});
  automation_id_19 = new Automation<>(blind_cover->get_close_trigger());
  ...
  automation_id_19->add_actions({lambdaaction_id_11, stepper_settargetaction_id_3, script_scriptexecuteaction_id_18});
  automation_id_21 = new Automation<>(blind_cover->get_stop_trigger());
  ...
  automation_id_21->add_actions({lambdaaction_id_16, lambdaaction_id_17, script_scriptexecuteaction_id_20});
  blind_cover->set_has_stop(true);
  automation_id_20 = new Automation<float>(blind_cover->get_position_trigger());
  ...
  automation_id_20->add_actions({lambdaaction_id_12, lambdaaction_id_13, ifaction_id_5, stepper_settargetaction_id_4, script_scriptexecuteaction_id_19});
  ...
  script_scriptexecuteaction_id->set_args([=]() -> int {
      #line 29 "packages/tmc5160_stepper_esp8266_d1_mini.yaml"
  ...
  script_scriptexecuteaction_id_2->set_args([=]() -> int {
      #line 32 "packages/tmc5160_stepper_esp8266_d1_mini.yaml"
  ...
  script_scriptexecuteaction_id_3->set_args([=]() -> int {
      #line 35 "packages/tmc5160_stepper_esp8266_d1_mini.yaml"
  ...
  sensor_sensorpublishaction_id = new sensor::SensorPublishAction<>(c_bedroom_window_blind_closed_position);
  sensor_sensorpublishaction_id->set_state([=]() -> float {
      #line 14 "packages/roller_blind.yaml"
      return closed_position->value();
  });
  sensor_sensorpublishaction_id_2 = new sensor::SensorPublishAction<>(c_bedroom_window_blind_closing_counter);
  sensor_sensorpublishaction_id_2->set_state([=]() -> float {
      #line 17 "packages/roller_blind.yaml"
      return closing_counter->value();
  });
  sensor_sensorpublishaction_id_3 = new sensor::SensorPublishAction<>(c_bedroom_window_blind_opening_counter);
  sensor_sensorpublishaction_id_3->set_state([=]() -> float {
      #line 20 "packages/roller_blind.yaml"
      return opening_counter->value();
  });
  sensor_sensorpublishaction_id_4 = new sensor::SensorPublishAction<>(c_bedroom_window_blind_opening_clutch_backlash_adjustment);
