...
template_::TemplateSensor *gym_window_blind_current_position;
template_::TemplateSensor *gym_window_blind_closed_position;
template_::TemplateSensor *gym_window_blind_opening_counter;
template_::TemplateSensor *gym_window_blind_closing_counter;
template_::TemplateSensor *gym_window_blind_opening_clutch_backlash_adjustment;
...
void setup() {
  ...
  //     priority: 600.0
  //   build_path: build/gym-window-blind
  //   friendly_name: ''
  //   area: ''
  //   platformio_options: {}
  //   includes: []
  ...
  App.pre_setup("gym-window-blind", "", "", "", __DATE__ ", " __TIME__, false);
  // stepper:
  // cover:
  // sensor:
  // logger:
  ...
  // wifi:
  //   manual_ip:
  //     static_ip: !secret 'wifi_static_ip_gym_window_blind'
  //     gateway: !secret 'wifi_gateway'
  //     subnet: 255.255.255.0
  //     dns1: 0.0.0.0
  //     dns2: 0.0.0.0
  //   ap:
  //     ssid: '{gym_window_blind}'
  //     password: password
  //     id: wifi_wifiap_id
  //     ap_timeout: 1min
  ...
  //     id: wifi_wifiap_id_2
  //     priority: 0.0
  //   use_address: 192.168.66.23
  wifi_wificomponent_id = new wifi::WiFiComponent();
  wifi_wificomponent_id->set_use_address("192.168.66.23");
  {
  ...
  wifi_wifiap_id_2.set_manual_ip(wifi::ManualIP{
      .static_ip = network::IPAddress(192, 168, 66, 23),
  ...
  wifi_wifiap_id.set_ssid("{gym_window_blind}");
  ...
  //         id(gym_window_blind_opening_clutch_backlash_adjustment).publish_state(id(opening_counter));
  ...
  //             id(gym_window_blind_opening_counter).publish_state(id(opening_counter));
  //   
  //             id(closing_counter) = 0;
  //             id(gym_window_blind_closing_counter).publish_state(id(closing_counter));
  ...
  //     - sensor.template.publish:
  //         id: gym_window_blind_current_position
  //         state: !lambda |-
  //           return id(tmc_stepper).current_position;
  ...
  blind_cover->set_name("Gym Window Blind");
  blind_cover->set_object_id("gym_window_blind");
  ...
  //   platform: template
  //   id: gym_window_blind_current_position
  //   name: Gym Window Blind Current position
  //   lambda: !lambda |-
  //     return id(tmc_stepper).current_position;
  ...
  //   force_update: false
  //   accuracy_decimals: 1
  gym_window_blind_current_position = new template_::TemplateSensor();
  App.register_sensor(gym_window_blind_current_position);
  gym_window_blind_current_position->set_name("Gym Window Blind Current position");
  gym_window_blind_current_position->set_object_id("gym_window_blind_current_position");
  gym_window_blind_current_position->set_disabled_by_default(false);
  gym_window_blind_current_position->set_accuracy_decimals(1);
  gym_window_blind_current_position->set_force_update(false);
  gym_window_blind_current_position->set_update_interval(4294967295UL);
  gym_window_blind_current_position->set_component_source("template.sensor");
  App.register_component(gym_window_blind_current_position);
  gym_window_blind_current_position->set_template([=]() -> optional<float> {
  ...
  //   platform: template
  //   id: gym_window_blind_closed_position
  //   name: Gym Window Blind Closed position
  //   lambda: !lambda |-
  //     return id(closed_position);
  //   update_interval: 4294967295
  //   disabled_by_default: false
  //   force_update: false
  //   accuracy_decimals: 1
  gym_window_blind_closed_position = new template_::TemplateSensor();
  App.register_sensor(gym_window_blind_closed_position);
  gym_window_blind_closed_position->set_name("Gym Window Blind Closed position");
  gym_window_blind_closed_position->set_object_id("gym_window_blind_closed_position");
  gym_window_blind_closed_position->set_disabled_by_default(false);
  gym_window_blind_closed_position->set_accuracy_decimals(1);
  gym_window_blind_closed_position->set_force_update(false);
  gym_window_blind_closed_position->set_update_interval(4294967295UL);
  gym_window_blind_closed_position->set_component_source("template.sensor");
  App.register_component(gym_window_blind_closed_position);
  // sensor.template:
  //   platform: template
  //   id: gym_window_blind_opening_counter
  //   name: Gym Window Blind Opening Counter
  //   lambda: !lambda |-
  //     return id(opening_counter);
  //   update_interval: 4294967295
  //   disabled_by_default: false
  //   force_update: false
  //   accuracy_decimals: 1
  gym_window_blind_opening_counter = new template_::TemplateSensor();
  App.register_sensor(gym_window_blind_opening_counter);
  gym_window_blind_opening_counter->set_name("Gym Window Blind Opening Counter");
  gym_window_blind_opening_counter->set_object_id("gym_window_blind_opening_counter");
  gym_window_blind_opening_counter->set_disabled_by_default(false);
  gym_window_blind_opening_counter->set_accuracy_decimals(1);
  gym_window_blind_opening_counter->set_force_update(false);
  gym_window_blind_opening_counter->set_update_interval(4294967295UL);
  gym_window_blind_opening_counter->set_component_source("template.sensor");
  App.register_component(gym_window_blind_opening_counter);
  // sensor.template:
  //   platform: template
  //   id: gym_window_blind_closing_counter
  //   name: Gym Window Blind Closing Counter
  //   lambda: !lambda |-
  //     return id(closing_counter);
  //   update_interval: 4294967295
  //   disabled_by_default: false
  //   force_update: false
  //   accuracy_decimals: 1
  gym_window_blind_closing_counter = new template_::TemplateSensor();
  App.register_sensor(gym_window_blind_closing_counter);
  gym_window_blind_closing_counter->set_name("Gym Window Blind Closing Counter");
  gym_window_blind_closing_counter->set_object_id("gym_window_blind_closing_counter");
  gym_window_blind_closing_counter->set_disabled_by_default(false);
  gym_window_blind_closing_counter->set_accuracy_decimals(1);
  gym_window_blind_closing_counter->set_force_update(false);
  gym_window_blind_closing_counter->set_update_interval(4294967295UL);
  gym_window_blind_closing_counter->set_component_source("template.sensor");
  App.register_component(gym_window_blind_closing_counter);
  // sensor.template:
  //   platform: template
  //   id: gym_window_blind_opening_clutch_backlash_adjustment
  //   name: Gym Window Blind Opening Clutch Backlash Adjustment
  //   lambda: !lambda |-
  //     return id(opening_clutch_backlash_adjustment);
  //   update_interval: 4294967295
  //   disabled_by_default: false
  //   force_update: false
  //   accuracy_decimals: 1
  gym_window_blind_opening_clutch_backlash_adjustment = new template_::TemplateSensor();
  App.register_sensor(gym_window_blind_opening_clutch_backlash_adjustment);
  gym_window_blind_opening_clutch_backlash_adjustment->set_name("Gym Window Blind Opening Clutch Backlash Adjustment");
  gym_window_blind_opening_clutch_backlash_adjustment->set_object_id("gym_window_blind_opening_clutch_backlash_adjustment");
  gym_window_blind_opening_clutch_backlash_adjustment->set_disabled_by_default(false);
  gym_window_blind_opening_clutch_backlash_adjustment->set_accuracy_decimals(1);
  gym_window_blind_opening_clutch_backlash_adjustment->set_force_update(false);
  gym_window_blind_opening_clutch_backlash_adjustment->set_update_interval(4294967295UL);
  gym_window_blind_opening_clutch_backlash_adjustment->set_component_source("template.sensor");
  App.register_component(gym_window_blind_opening_clutch_backlash_adjustment);
  // sensor.uptime:
  //   platform: uptime
  //   name: Uptime Sensor
  //   disabled_by_default: false
  ...
  blind_cover->set_has_position(true);
  gym_window_blind_closed_position->set_template([=]() -> optional<float> {
      #line 265 "packages/roller_blind.yaml"
      return closed_position->value();
  });
  gym_window_blind_opening_counter->set_template([=]() -> optional<float> {
      #line 271 "packages/roller_blind.yaml"
      return opening_counter->value();
  });
  gym_window_blind_closing_counter->set_template([=]() -> optional<float> {
      #line 277 "packages/roller_blind.yaml"
      return closing_counter->value();
  });
  gym_window_blind_opening_clutch_backlash_adjustment->set_template([=]() -> optional<float> {
  ...
  sensor_sensorpublishaction_id = new sensor::SensorPublishAction<>(gym_window_blind_closed_position);
  sensor_sensorpublishaction_id->set_state([=]() -> float {
      #line 14 "packages/roller_blind.yaml"
      return closed_position->value();
  });
  sensor_sensorpublishaction_id_2 = new sensor::SensorPublishAction<>(gym_window_blind_closing_counter);
  sensor_sensorpublishaction_id_2->set_state([=]() -> float {
      #line 17 "packages/roller_blind.yaml"
      return closing_counter->value();
  });
  sensor_sensorpublishaction_id_3 = new sensor::SensorPublishAction<>(gym_window_blind_opening_counter);
  sensor_sensorpublishaction_id_3->set_state([=]() -> float {
      #line 20 "packages/roller_blind.yaml"
      return opening_counter->value();
  });
  sensor_sensorpublishaction_id_4 = new sensor::SensorPublishAction<>(gym_window_blind_opening_clutch_backlash_adjustment);
  ...
  lambdaaction_id = new LambdaAction<int32_t>([=](int32_t clutch_backlash_adjustment) -> void {
      ...
      gym_window_blind_opening_clutch_backlash_adjustment->publish_state(opening_counter->value());
  });
  ...
  lambdaaction_id_2 = new LambdaAction<>([=]() -> void {
      ...
      gym_window_blind_opening_counter->publish_state(opening_counter->value());
      
      closing_counter->value() = 0;
      gym_window_blind_closing_counter->publish_state(closing_counter->value());
  });
  ...
  sensor_sensorpublishaction_id_5 = new sensor::SensorPublishAction<>(gym_window_blind_current_position);
