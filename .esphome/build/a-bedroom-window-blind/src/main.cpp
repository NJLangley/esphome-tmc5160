...
template_::TemplateSensor *a_bedroom_window_blind_current_position;
template_::TemplateSensor *a_bedroom_window_blind_closed_position;
template_::TemplateSensor *a_bedroom_window_blind_opening_counter;
template_::TemplateSensor *a_bedroom_window_blind_closing_counter;
template_::TemplateSensor *a_bedroom_window_blind_opening_clutch_backlash_adjustment;
...
void setup() {
  ...
  //     priority: 600.0
  //   build_path: build/a-bedroom-window-blind
  //   friendly_name: ''
  //   area: ''
  //   platformio_options: {}
  //   includes: []
  ...
  App.pre_setup("a-bedroom-window-blind", "", "", "", __DATE__ ", " __TIME__, false);
  // stepper:
  // cover:
  // sensor:
  // logger:
  ...
  // wifi:
  //   manual_ip:
  //     static_ip: !secret 'wifi_static_ip_a_bedroom_window_blind'
  //     gateway: !secret 'wifi_gateway'
  //     subnet: 255.255.255.0
  //     dns1: 0.0.0.0
  //     dns2: 0.0.0.0
  //   ap:
  //     ssid: '{a_bedroom_window_blind}-test'
  //     password: password
  //     id: wifi_wifiap_id
  //     ap_timeout: 1min
  ...
  //     id: wifi_wifiap_id_2
  //     priority: 0.0
  //   use_address: 192.168.66.27
  wifi_wificomponent_id = new wifi::WiFiComponent();
  wifi_wificomponent_id->set_use_address("192.168.66.27");
  {
  ...
  wifi_wifiap_id_2.set_manual_ip(wifi::ManualIP{
      .static_ip = network::IPAddress(192, 168, 66, 27),
  ...
  wifi_wifiap_id.set_ssid("{a_bedroom_window_blind}-test");
  ...
  //         id(a_bedroom_window_blind_opening_clutch_backlash_adjustment).publish_state(id(opening_counter));
  ...
  //             id(a_bedroom_window_blind_opening_counter).publish_state(id(opening_counter));
  //   
  //             id(closing_counter) = 0;
  //             id(a_bedroom_window_blind_closing_counter).publish_state(id(closing_counter));
  ...
  // substitutions:
  //   device_name: a-bedroom-window-blind
  //   friendly_name: A Bedroom Window Blind
  //   node_name: a_bedroom_window_blind
  //   wifi_static_ip: !secret 'wifi_static_ip_a_bedroom_window_blind'
  ...
  //     - sensor.template.publish:
  //         id: a_bedroom_window_blind_current_position
  //         state: !lambda |-
  //           return id(tmc_stepper).current_position;
  ...
  blind_cover->set_name("A Bedroom Window Blind");
  blind_cover->set_object_id("a_bedroom_window_blind");
  ...
  //   platform: template
  //   id: a_bedroom_window_blind_current_position
  //   name: A Bedroom Window Blind Current position
  //   lambda: !lambda |-
  //     return id(tmc_stepper).current_position;
  ...
  //   force_update: false
  //   accuracy_decimals: 1
  a_bedroom_window_blind_current_position = new template_::TemplateSensor();
  App.register_sensor(a_bedroom_window_blind_current_position);
  a_bedroom_window_blind_current_position->set_name("A Bedroom Window Blind Current position");
  a_bedroom_window_blind_current_position->set_object_id("a_bedroom_window_blind_current_position");
  a_bedroom_window_blind_current_position->set_disabled_by_default(false);
  a_bedroom_window_blind_current_position->set_accuracy_decimals(1);
  a_bedroom_window_blind_current_position->set_force_update(false);
  a_bedroom_window_blind_current_position->set_update_interval(4294967295UL);
  a_bedroom_window_blind_current_position->set_component_source("template.sensor");
  App.register_component(a_bedroom_window_blind_current_position);
  a_bedroom_window_blind_current_position->set_template([=]() -> optional<float> {
  ...
  //   platform: template
  //   id: a_bedroom_window_blind_closed_position
  //   name: A Bedroom Window Blind Closed position
  //   lambda: !lambda |-
  //     return id(closed_position);
  //   update_interval: 4294967295
  //   disabled_by_default: false
  //   force_update: false
  //   accuracy_decimals: 1
  a_bedroom_window_blind_closed_position = new template_::TemplateSensor();
  App.register_sensor(a_bedroom_window_blind_closed_position);
  a_bedroom_window_blind_closed_position->set_name("A Bedroom Window Blind Closed position");
  a_bedroom_window_blind_closed_position->set_object_id("a_bedroom_window_blind_closed_position");
  a_bedroom_window_blind_closed_position->set_disabled_by_default(false);
  a_bedroom_window_blind_closed_position->set_accuracy_decimals(1);
  a_bedroom_window_blind_closed_position->set_force_update(false);
  a_bedroom_window_blind_closed_position->set_update_interval(4294967295UL);
  a_bedroom_window_blind_closed_position->set_component_source("template.sensor");
  App.register_component(a_bedroom_window_blind_closed_position);
  // sensor.template:
  //   platform: template
  //   id: a_bedroom_window_blind_opening_counter
  //   name: A Bedroom Window Blind Opening Counter
  //   lambda: !lambda |-
  //     return id(opening_counter);
  //   update_interval: 4294967295
  //   disabled_by_default: false
  //   force_update: false
  //   accuracy_decimals: 1
  a_bedroom_window_blind_opening_counter = new template_::TemplateSensor();
  App.register_sensor(a_bedroom_window_blind_opening_counter);
  a_bedroom_window_blind_opening_counter->set_name("A Bedroom Window Blind Opening Counter");
  a_bedroom_window_blind_opening_counter->set_object_id("a_bedroom_window_blind_opening_counter");
  a_bedroom_window_blind_opening_counter->set_disabled_by_default(false);
  a_bedroom_window_blind_opening_counter->set_accuracy_decimals(1);
  a_bedroom_window_blind_opening_counter->set_force_update(false);
  a_bedroom_window_blind_opening_counter->set_update_interval(4294967295UL);
  a_bedroom_window_blind_opening_counter->set_component_source("template.sensor");
  App.register_component(a_bedroom_window_blind_opening_counter);
  // sensor.template:
  //   platform: template
  //   id: a_bedroom_window_blind_closing_counter
  //   name: A Bedroom Window Blind Closing Counter
  //   lambda: !lambda |-
  //     return id(closing_counter);
  //   update_interval: 4294967295
  //   disabled_by_default: false
  //   force_update: false
  //   accuracy_decimals: 1
  a_bedroom_window_blind_closing_counter = new template_::TemplateSensor();
  App.register_sensor(a_bedroom_window_blind_closing_counter);
  a_bedroom_window_blind_closing_counter->set_name("A Bedroom Window Blind Closing Counter");
  a_bedroom_window_blind_closing_counter->set_object_id("a_bedroom_window_blind_closing_counter");
  a_bedroom_window_blind_closing_counter->set_disabled_by_default(false);
  a_bedroom_window_blind_closing_counter->set_accuracy_decimals(1);
  a_bedroom_window_blind_closing_counter->set_force_update(false);
  a_bedroom_window_blind_closing_counter->set_update_interval(4294967295UL);
  a_bedroom_window_blind_closing_counter->set_component_source("template.sensor");
  App.register_component(a_bedroom_window_blind_closing_counter);
  // sensor.template:
  //   platform: template
  //   id: a_bedroom_window_blind_opening_clutch_backlash_adjustment
  //   name: A Bedroom Window Blind Opening Clutch Backlash Adjustment
  //   lambda: !lambda |-
  //     return id(opening_clutch_backlash_adjustment);
  //   update_interval: 4294967295
  //   disabled_by_default: false
  //   force_update: false
  //   accuracy_decimals: 1
  a_bedroom_window_blind_opening_clutch_backlash_adjustment = new template_::TemplateSensor();
  App.register_sensor(a_bedroom_window_blind_opening_clutch_backlash_adjustment);
  a_bedroom_window_blind_opening_clutch_backlash_adjustment->set_name("A Bedroom Window Blind Opening Clutch Backlash Adjustment");
  a_bedroom_window_blind_opening_clutch_backlash_adjustment->set_object_id("a_bedroom_window_blind_opening_clutch_backlash_adjustment");
  a_bedroom_window_blind_opening_clutch_backlash_adjustment->set_disabled_by_default(false);
  a_bedroom_window_blind_opening_clutch_backlash_adjustment->set_accuracy_decimals(1);
  a_bedroom_window_blind_opening_clutch_backlash_adjustment->set_force_update(false);
  a_bedroom_window_blind_opening_clutch_backlash_adjustment->set_update_interval(4294967295UL);
  a_bedroom_window_blind_opening_clutch_backlash_adjustment->set_component_source("template.sensor");
  App.register_component(a_bedroom_window_blind_opening_clutch_backlash_adjustment);
  // sensor.uptime:
  //   platform: uptime
  //   name: Uptime Sensor
  //   disabled_by_default: false
  ...
  blind_cover->set_has_position(true);
  a_bedroom_window_blind_closed_position->set_template([=]() -> optional<float> {
      #line 265 "packages/roller_blind.yaml"
      return closed_position->value();
  });
  a_bedroom_window_blind_opening_counter->set_template([=]() -> optional<float> {
      #line 271 "packages/roller_blind.yaml"
      return opening_counter->value();
  });
  a_bedroom_window_blind_closing_counter->set_template([=]() -> optional<float> {
      #line 277 "packages/roller_blind.yaml"
      return closing_counter->value();
  });
  a_bedroom_window_blind_opening_clutch_backlash_adjustment->set_template([=]() -> optional<float> {
  ...
  sensor_sensorpublishaction_id = new sensor::SensorPublishAction<>(a_bedroom_window_blind_closed_position);
  sensor_sensorpublishaction_id->set_state([=]() -> float {
      #line 14 "packages/roller_blind.yaml"
      return closed_position->value();
  });
  sensor_sensorpublishaction_id_2 = new sensor::SensorPublishAction<>(a_bedroom_window_blind_closing_counter);
  sensor_sensorpublishaction_id_2->set_state([=]() -> float {
      #line 17 "packages/roller_blind.yaml"
      return closing_counter->value();
  });
  sensor_sensorpublishaction_id_3 = new sensor::SensorPublishAction<>(a_bedroom_window_blind_opening_counter);
  sensor_sensorpublishaction_id_3->set_state([=]() -> float {
      #line 20 "packages/roller_blind.yaml"
      return opening_counter->value();
  });
  sensor_sensorpublishaction_id_4 = new sensor::SensorPublishAction<>(a_bedroom_window_blind_opening_clutch_backlash_adjustment);
  ...
  lambdaaction_id = new LambdaAction<int32_t>([=](int32_t clutch_backlash_adjustment) -> void {
      ...
      a_bedroom_window_blind_opening_clutch_backlash_adjustment->publish_state(opening_counter->value());
  });
  ...
  lambdaaction_id_2 = new LambdaAction<>([=]() -> void {
      ...
      a_bedroom_window_blind_opening_counter->publish_state(opening_counter->value());
      
      closing_counter->value() = 0;
      a_bedroom_window_blind_closing_counter->publish_state(closing_counter->value());
  });
  ...
  sensor_sensorpublishaction_id_5 = new sensor::SensorPublishAction<>(a_bedroom_window_blind_current_position);
